...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles, '3.16').matchup(1, men.Popyrin, 2, men.Djokovic).select(1,4)  # (   ) Alexei Popyrin  OR  (  2) Novak Djokovic
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles, '2.32').matchup(1, men.Fearnley, 2, men.Djokovic).select(1,3)  # ( WC) Jacob Fearnley  OR  (  2) Novak Djokovic

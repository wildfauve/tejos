...
def mens_singles_round_5(mens_singles):
    ...
    TEAM.draw(mens_singles, '5.2').matchup(1, men.Alcaraz, 2, men.Paul).select(1,3)  # (  3) Carlos Alcaraz  OR  ( 12) Tommy Paul
    TEAM.draw(mens_singles, '5.3').matchup(1, men.Musetti, 2, men.Fritz).select(2,4)  # ( 25) Lorenzo Musetti  OR  ( 13) Taylor Fritz
    TEAM.draw(mens_singles, '5.4').matchup(1, men.Alex_de_Minaur, 2, men.Djokovic).select(2,4)  # (  9) Alex de Minaur  OR  (  2) Novak Djokovic
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles, '4.7').matchup(1, men.Fils, 2, men.Alex_de_Minaur).select(2,5)  # (   ) Arthur Fils  OR  (  9) Alex de Minaur

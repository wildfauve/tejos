...
def womens_singles_round_5(womens_singles):
    ...
    TEAM.draw(womens_singles, '5.4').matchup(1, women.Navarro, 2, women.Paolini).select(1,3)  # ( 19) Emma Navarro  OR  (  7) Jasmine Paolini
# womens_singles_round_5:END

# mens_singles_round_5:START
def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles, '5.1').matchup(1, men.Sinner, 2, men.Medvedev).select(1,5)  # (  1) Jannik Sinner  OR  (  5) Daniil Medvedev
    TEAM.draw(mens_singles, '5.2').matchup(1, men.Alcaraz, 2, men.Paul).select(1,4)  # (  3) Carlos Alcaraz  OR  ( 12) Tommy Paul
    TEAM.draw(mens_singles, '5.3').matchup(1, men.Musetti, 2, men.Fritz).select(1,5)  # ( 25) Lorenzo Musetti  OR  ( 13) Taylor Fritz
    TEAM.draw(mens_singles, '5.4').matchup(1, men.Alex_de_Minaur, 2, men.Djokovic).select(2,3)  # (  9) Alex de Minaur  OR  (  2) Novak Djokovic
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles).match('4.2').winner(women.Collins).in_sets(3)  # ( 11) Danielle Collins  OR  ( 31) Barbora Krejcikova
    ...
    TEAM.draw(womens_singles).match('4.6').winner(women.Badosa).in_sets(3)  # (   ) Paula Badosa  OR  (   ) Donna Vekic
    TEAM.draw(womens_singles).match('4.7').winner(women.Keys).in_sets(3)  # (  7) Jasmine Paolini  OR  ( 12) Madison Keys
    TEAM.draw(womens_singles).match('4.8').winner(women.Gauff).in_sets(3)  # ( 19) Emma Navarro  OR  (  2) Coco Gauff
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles).match('4.2').winner(men.Medvedev).in_sets(3)  # ( 10) Grigor Dimitrov  OR  (  5) Daniil Medvedev
...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles, '3.3').matchup(1, women.Collins, 2, women.Haddad_Maia).select(1,2)  # ( 11) Danielle Collins  OR  ( 20) Beatriz Haddad Maia
    TEAM.draw(womens_singles, '3.4').matchup(1, women.Krejcikova, 2, women.Maneiro).select(1,3)  # ( 31) Barbora Krejcikova  OR  (   ) Jessica Bouzas Maneiro
    TEAM.draw(womens_singles, '3.5').matchup(1, women.Rybakina, 2, women.Caroline_Wozniacki).select(1,3)  # (  4) Elena Rybakina  OR  ( WC) Caroline Wozniacki
    TEAM.draw(womens_singles, '3.6').matchup(1, women.Kalinskaya, 2, women.Samsonova).select(1,3)  # ( 17) Anna Kalinskaya  OR  ( 15) Liudmila Samsonova
    TEAM.draw(womens_singles, '3.7').matchup(1, women.Jabeur, 2, women.Svitolina).select(2,3)  # ( 10) Ons Jabeur  OR  ( 21) Svitolina
    TEAM.draw(womens_singles, '3.8').matchup(1, women.Dart, 2, women.Wang_Xinyu).select(1,3)  # (   ) Harriet Dart  OR  (   ) Xinyu Wang
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles, '3.9').matchup(1, men.Comesana, 2, men.Musetti).select(2,4)  # (   ) Francisco Comesana  OR  ( 25) Lorenzo Musetti
    TEAM.draw(mens_singles, '3.10').matchup(1, men.Perricard, 2, men.Ruusuvuori).select(2,4)  # ( LL) Giovanni Mpetshi Perricard  OR  (   ) Emil Ruusuvuori
    TEAM.draw(mens_singles, '3.11').matchup(1, men.Fritz, 2, men.Tabilo).select(1,4)  # ( 13) Taylor Fritz  OR  ( 24) Alejandro Tabilo
    TEAM.draw(mens_singles, '3.12').matchup(1, men.Norrie, 2, men.Zverev).select(2,4)  # (   ) Cameron Norrie  OR  (  4) Alexander Zverev
    TEAM.draw(mens_singles, '3.13').matchup(1, men.Fils, 2, men.Safiullin).select(1,4)  # (   ) Arthur Fils  OR  (   ) Roman Safiullin
    TEAM.draw(mens_singles, '3.14').matchup(1, men.Pouille, 2, men.Alex_de_Minaur).select(2,4)  # (  Q) Lucas Pouille  OR  (  9) Alex de Minaur
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles, '2.10').matchup(1, women.Caroline_Wozniacki, 2, women.Fernandez).select(2,3)  # ( WC) Caroline Wozniacki  OR  ( 30) Leylah Fernandez
    TEAM.draw(womens_singles, '2.11').matchup(1, women.Kalinskaya, 2, women.Bouzkova).select(1,3)  # ( 17) Anna Kalinskaya  OR  (   ) Marie Bouzkova
    ...
    TEAM.draw(womens_singles, '2.15').matchup(1, women.Boulter, 2, women.Dart).select(1,2)  # ( 32) Katie Boulter  OR  (   ) Harriet Dart
...
def mens_singles_round_2(mens_singles):
    TEAM.draw(mens_singles, '2.1').matchup(1, men.Sinner, 2, men.Berrettini).select(1,3)  # (  1) Jannik Sinner  OR  (   ) Matteo Berrettini
    ...
    TEAM.draw(mens_singles, '2.3').matchup(1, men.Shapovalov, 2, men.Altmaier).select(2,4)  # (   ) Denis Shapovalov  OR  (   ) Daniel Altmaier
    TEAM.draw(mens_singles, '2.4').matchup(1, men.Harris, 2, men.Shelton).select(2,4)  # (  Q) Lloyd Harris  OR  ( 14) Ben Shelton
    TEAM.draw(mens_singles, '2.5').matchup(1, men.Dimitrov, 2, men.Shang).select(1,4)  # ( 10) Grigor Dimitrov  OR  (   ) Juncheng Shang
    TEAM.draw(mens_singles, '2.6').matchup(1, men.Wawrinka, 2, men.Monfils).select(2,4)  # (   ) Stan Wawrinka  OR  (   ) Gael Monfils
    ...
    TEAM.draw(mens_singles, '2.11').matchup(1, men.Nakashima, 2, men.Thompson).select(2,4)  # (   ) Brandon Nakashima  OR  (   ) Jordan Thompson
    ...
    TEAM.draw(mens_singles, '2.13').matchup(1, men.Paul, 2, men.Otto_Virtanen).select(1,4)  # ( 12) Tommy Paul  OR  (  Q) Otto Virtanen
    ...
    TEAM.draw(mens_singles, '2.23').matchup(1, men.Draper, 2, men.Norrie).select(1,4)  # ( 28) Jack Draper  OR  (   ) Cameron Norrie
...
def womens_singles_round_1(womens_singles):
    ...
    TEAM.draw(womens_singles, '1.47').matchup(1, women.Vekic, 2, women.Wang_Xiyu).select(1,3)  # (   ) Donna Vekic  OR  (   ) Xiyu Wang
    ...
    TEAM.draw(womens_singles, '1.61').matchup(1, women.Cirstea, 2, women.Kartal).select(1,3)  # ( 29) Sorana Cirstea  OR  (  Q) Sonay Kartal
...
def mens_singles_round_1(mens_singles):
    ...
    TEAM.draw(mens_singles, '1.11').matchup(1, men.Wawrinka, 2, men.Broom).select(1,4)  # (   ) Stan Wawrinka  OR  ( WC) Charles Broom
    ...
    TEAM.draw(mens_singles, '1.29').matchup(1, men.Navone, 2, men.Sonego).select(1,4)  # ( 31) Mariano Navone  OR  (   ) Lorenzo Sonego
    ...
    TEAM.draw(mens_singles, '1.31').matchup(1, men.Van_Assche, 2, men.Fognini).select(2,4)  # ( LL) Luca Van Assche  OR  (   ) Fabio Fognini

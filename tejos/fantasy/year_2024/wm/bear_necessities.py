...
def womens_singles_round_1(womens_singles):
    ...
    TEAM.draw(womens_singles, '1.6').matchup(1, women.Pera, 2, women.Potapova).select(1,3)  # (   ) Bernarda Pera  OR  (   ) Anastasia Potapova
    ...
    TEAM.draw(womens_singles, '1.16').matchup(1, women.Maneiro, 2, women.Vondrousova).select(1,2)  # (   ) Jessica Bouzas Maneiro  OR  (  6) Marketa Vondrousova
    ...
    TEAM.draw(womens_singles, '1.20').matchup(1, women.Bronzetti, 2, women.Fernandez).select(1,3)  # (   ) Lucia Bronzetti  OR  ( 30) Leylah Fernandez
    ...
    TEAM.draw(womens_singles, '1.37').matchup(1, women.Renata_Zarazua, 2, women.Raducanu).select(2,2)  # ( LL) Renata Zarazua  OR  ( WC) Emma Raducanu
    ...
    TEAM.draw(womens_singles, '1.42').matchup(1, women.Korpatsch, 2, women.Yuriko_Lily_Miyazaki).select(2,2)  # (   ) Tamara Korpatsch  OR  ( WC) Yuriko Lily Miyazaki
    ...
    TEAM.draw(womens_singles, '1.54').matchup(1, women.Saville, 2, women.Stearns).select(1,2)  # (   ) Daria Saville  OR  (   ) Peyton Stearns

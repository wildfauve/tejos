...
def womens_singles_round_5(womens_singles):
    TEAM.draw(womens_singles, '5.1').matchup(1, women.Ostapenko, 2, women.Krejcikova).select()  # ( 13) Jelena Ostapenko  OR  ( 31) Barbora Krejcikova
    TEAM.draw(womens_singles, '5.2').matchup(1, women.Svitolina, 2, women.Rybakina).select()  # ( 21) Svitolina  OR  (  4) Elena Rybakina
    TEAM.draw(womens_singles, '5.3').matchup(1, women.Lulu_Sun, 2, women.Vekic).select()  # (  Q) Lulu Sun  OR  (   ) Donna Vekic
    TEAM.draw(womens_singles, '5.4').matchup(1, women.Navarro, 2, women.Paolini).select()  # ( 19) Emma Navarro  OR  (  7) Jasmine Paolini
# womens_singles_round_5:END


# mens_singles_round_5:START
def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles, '5.1').matchup(1, men.Sinner, 2, men.Medvedev).select()  # (  1) Jannik Sinner  OR  (  5) Daniil Medvedev
    TEAM.draw(mens_singles, '5.2').matchup(1, men.Alcaraz, 2, men.Paul).select()  # (  3) Carlos Alcaraz  OR  ( 12) Tommy Paul
    TEAM.draw(mens_singles, '5.3').matchup(1, men.Musetti, 2, men.Fritz).select()  # ( 25) Lorenzo Musetti  OR  ( 13) Taylor Fritz
    TEAM.draw(mens_singles, '5.4').matchup(1, men.Alex_de_Minaur, 2, men.Djokovic).select()  # (  9) Alex de Minaur  OR  (  2) Novak Djokovic
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles, '4.2').matchup(1, women.Collins, 2, women.Krejcikova).select()  # ( 11) Danielle Collins  OR  ( 31) Barbora Krejcikova
...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles, '3.10').matchup(1, women.Raducanu, 2, women.Sakkari).select(1,2)  # ( WC) Emma Raducanu  OR  (  9) Maria Sakkari
    TEAM.draw(womens_singles, '3.11').matchup(1, women.Kasatkina, 2, women.Badosa).select(2,3)  # ( 14) Daria Kasatkina  OR  (   ) Paula Badosa
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles, '3.3').matchup(1, men.Dimitrov, 2, men.Monfils).select(1,3)  # ( 10) Grigor Dimitrov  OR  (   ) Gael Monfils
    TEAM.draw(mens_singles, '3.4').matchup(1, men.Struff, 2, men.Medvedev).select(2,4)  # (   ) Jan-Lennard Struff  OR  (  5) Daniil Medvedev
    TEAM.draw(mens_singles, '3.5').matchup(1, men.Alcaraz, 2, men.Tiafoe).select(1,5)  # (  3) Carlos Alcaraz  OR  ( 29) Frances Tiafoe
    TEAM.draw(mens_singles, '3.6').matchup(1, men.Nakashima, 2, men.Humbert).select(2,4)  # (   ) Brandon Nakashima  OR  ( 16) Ugo Humbert
    TEAM.draw(mens_singles, '3.7').matchup(1, men.Paul, 2, men.Bublik).select(1,3)  # ( 12) Tommy Paul  OR  ( 23) Alexander Bublik

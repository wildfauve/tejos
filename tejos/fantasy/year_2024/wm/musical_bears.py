...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles, '3.9').matchup(1, women.Lulu_Sun, 2, women.Zhu).select(2,3)  # (  Q) Lulu Sun  OR  (   ) Lin Zhu
    TEAM.draw(womens_singles, '3.10').matchup(1, women.Raducanu, 2, women.Sakkari).select(2,2)  # ( WC) Emma Raducanu  OR  (  9) Maria Sakkari
    TEAM.draw(womens_singles, '3.11').matchup(1, women.Kasatkina, 2, women.Badosa).select(1,2)  # ( 14) Daria Kasatkina  OR  (   ) Paula Badosa
    TEAM.draw(womens_singles, '3.12').matchup(1, women.Yastremska, 2, women.Vekic).select(1,2)  # ( 28) Dayana Yastremska  OR  (   ) Donna Vekic
    TEAM.draw(womens_singles, '3.13').matchup(1, women.Paolini, 2, women.Andreescu).select(1,3)  # (  7) Jasmine Paolini  OR  (   ) Bianca Andreescu
    TEAM.draw(womens_singles, '3.14').matchup(1, women.Kostyuk, 2, women.Keys).select(2,3)  # ( 18) Marta Kostyuk  OR  ( 12) Madison Keys
    TEAM.draw(womens_singles, '3.15').matchup(1, women.Shnaider, 2, women.Navarro).select(2,2)  # (   ) Diana Shnaider  OR  ( 19) Emma Navarro
...
def mens_singles_round_3(mens_singles):
    TEAM.draw(mens_singles, '3.1').matchup(1, men.Sinner, 2, men.Kecmanovic).select(1,4)  # (  1) Jannik Sinner  OR  (   ) Miomir Kecmanovic
    TEAM.draw(mens_singles, '3.2').matchup(1, men.Shapovalov, 2, men.Shelton).select(2,4)  # (   ) Denis Shapovalov  OR  ( 14) Ben Shelton
    TEAM.draw(mens_singles, '3.3').matchup(1, men.Dimitrov, 2, men.Monfils).select(1,4)  # ( 10) Grigor Dimitrov  OR  (   ) Gael Monfils
    TEAM.draw(mens_singles, '3.4').matchup(1, men.Struff, 2, men.Medvedev).select(2,3)  # (   ) Jan-Lennard Struff  OR  (  5) Daniil Medvedev
    TEAM.draw(mens_singles, '3.5').matchup(1, men.Alcaraz, 2, men.Tiafoe).select(1,3)  # (  3) Carlos Alcaraz  OR  ( 29) Frances Tiafoe
    TEAM.draw(mens_singles, '3.6').matchup(1, men.Nakashima, 2, men.Humbert).select(2,4)  # (   ) Brandon Nakashima  OR  ( 16) Ugo Humbert
    TEAM.draw(mens_singles, '3.7').matchup(1, men.Paul, 2, men.Bublik).select(1,4)  # ( 12) Tommy Paul  OR  ( 23) Alexander Bublik
    TEAM.draw(mens_singles, '3.8').matchup(1, men.Bautista_Agut, 2, men.Fognini).select(1,5)  # (   ) Roberto Bautista Agut  OR  (   ) Fabio Fognini
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles, '2.19').matchup(1, women.Raducanu, 2, women.Mertens).select(2,3)  # ( WC) Emma Raducanu  OR  (   ) Elise Mertens
    ...
    TEAM.draw(womens_singles, '2.22').matchup(1, women.Badosa, 2, women.Fruhvirtova_Brenda).select(2,2)  # (   ) Paula Badosa  OR  (   ) Brenda Fruhvirtova
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles, '2.6').matchup(1, men.Wawrinka, 2, men.Monfils).select(1,4)  # (   ) Stan Wawrinka  OR  (   ) Gael Monfils
...
def womens_singles_round_1(womens_singles):
    ...
    TEAM.draw(womens_singles, '1.27').matchup(1, women.Golubic, 2, women.Niemeier).select(1,3)  # (   ) Viktorija Golubic  OR  (   ) Jule Niemeier
...
def mens_singles_round_1(mens_singles):
    ...
    TEAM.draw(mens_singles, '1.42').matchup(1, men.Kei_Nishikori, 2, men.Rinderknech).select(1,4)  # (   ) Kei Nishikori  OR  (   ) Arthur Rinderknech
    ...
    TEAM.draw(mens_singles, '1.52').matchup(1, men.Safiullin, 2, men.Cerundolo_Francisco).select(2,3)  # (   ) Roman Safiullin  OR  ( 26) Francisco Cerundolo
    ...
    TEAM.draw(mens_singles, '1.59').matchup(1, men.Halys, 2, men.Eubanks).select(2,4)  # (  Q) Quentin Halys  OR  (   ) Christopher Eubanks

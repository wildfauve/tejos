...
def womens_singles_round_5(womens_singles):
    ...
    TEAM.draw(womens_singles, '5.3').matchup(1, women.Lulu_Sun, 2, women.Vekic).select(2,2)  # (  Q) Lulu Sun  OR  (   ) Donna Vekic
...
def mens_singles_round_5(mens_singles):
    ...
    TEAM.draw(mens_singles, '5.3').matchup(1, men.Musetti, 2, men.Fritz).select(2,5)  # ( 25) Lorenzo Musetti  OR  ( 13) Taylor Fritz

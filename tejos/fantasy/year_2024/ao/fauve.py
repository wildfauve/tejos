...
def womens_singles_round_7(womens_singles):
    TEAM.draw(womens_singles, '7.1').matchup(1, women.Sabalenka, 2, women.Zheng).select(1,2)  # (  2) Aryna Sabalenka  OR  ( 12) Qinwen Zheng
...
def womens_singles_round_6(womens_singles):
    TEAM.draw(womens_singles, '6.1').matchup(1, women.Yastremska, 2, women.Zheng).select(2,3)  # (  Q) Dayana Yastremska  OR  ( 12) Qinwen Zheng
...
def womens_singles_round_5(womens_singles):
    TEAM.draw(womens_singles, '5.1').matchup(1, women.Noskova, 2, women.Yastremska).select(2,2)  # (   ) Linda Noskova  OR  (  Q) Dayana Yastremska
    TEAM.draw(womens_singles, '5.2').matchup(1, women.Zheng, 2, women.Kalinskaya).select(1,3)  # ( 12) Qinwen Zheng  OR  (   ) Anna Kalinskaya
    TEAM.draw(womens_singles, '5.3').matchup(1, women.Kostyuk, 2, women.Gauff).select(2,2)  # (   ) Marta Kostyuk  OR  (  4) Coco Gauff
...
def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles, '5.1').matchup(1, men.Djokovic, 2, men.Fritz).select(1,3)  # (  1) Novak Djokovic  OR  ( 12) Taylor Fritz
    TEAM.draw(mens_singles, '5.2').matchup(1, men.Sinner, 2, men.Rublev).select(1,3)  # (  4) Jannik Sinner  OR  (  5) Andrey Rublev
    TEAM.draw(mens_singles, '5.3').matchup(1, men.Medvedev, 2, men.Hurkacz).select(1,4)  # (  3) Daniil Medvedev  OR  (  9) Hubert Hurkacz
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles, '4.2').matchup(1, women.Yastremska, 2, women.Azarenka).select(1,2)  # (  Q) Dayana Yastremska  OR  ( 18) Victoria Azarenka
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles, '4.7').matchup(1, men.Norrie, 2, men.Zverev).select(2,5)  # ( 19) Cameron Norrie  OR  (  6) Alexander Zverev

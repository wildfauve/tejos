...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles, '3.10').matchup(1, women.Haddad_Maia, 2, women.Maria_Timofeeva).select(1,3)  # ( 10) Beatriz Haddad Maia  OR  (  Q) Maria Timofeeva
    ...
    TEAM.draw(womens_singles, '3.15').matchup(1, women.Anisimova, 2, women.Badosa).select(2,3)  # (   ) Amanda Anisimova  OR  (   ) Paula Badosa
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles, '3.2').matchup(1, men.Mannarino, 2, men.Shelton).select(2,3)  # ( 20) Adrian Mannarino  OR  ( 16) Ben Shelton
    TEAM.draw(mens_singles, '3.3').matchup(1, men.Fritz, 2, men.Marozsan).select(1,3)  # ( 12) Taylor Fritz  OR  (   ) Fabian Marozsan
    TEAM.draw(mens_singles, '3.4').matchup(1, men.Van_Assche, 2, men.Tsitsipas).select(1,4)  # (   ) Luca Van Assche  OR  (  7) Stefanos Tsitsipas
    TEAM.draw(mens_singles, '3.5').matchup(1, men.Sinner, 2, men.Baez).select(1,4)  # (  4) Jannik Sinner  OR  ( 26) Sebastian Baez
    TEAM.draw(mens_singles, '3.6').matchup(1, men.Khachanov, 2, men.Machac).select(1,5)  # ( 15) Karen Khachanov  OR  (   ) Tomas Machac
    TEAM.draw(mens_singles, '3.7').matchup(1, men.Flavio_Cobolli, 2, men.Alex_de_Minaur).select(2,5)  # (  Q) Flavio Cobolli  OR  ( 10) Alex de Minaur

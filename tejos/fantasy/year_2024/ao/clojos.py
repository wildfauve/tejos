...
def mens_singles_round_7(mens_singles):
    TEAM.draw(mens_singles, '7.1').matchup(1, men.Medvedev, 2, men.Sinner).select(2,5)  # (  3) Daniil Medvedev  OR  (  4) Jannik Sinner
...
def womens_singles_round_6(womens_singles):
    ...
    TEAM.draw(womens_singles, '6.2').matchup(1, women.Sabalenka, 2, women.Gauff).select(1,3)  # (  2) Aryna Sabalenka  OR  (  4) Coco Gauff
# womens_singles_round_6:END


# mens_singles_round_6:START
def mens_singles_round_6(mens_singles):
    TEAM.draw(mens_singles, '6.1').matchup(1, men.Sinner, 2, men.Djokovic).select(1,5)  # (  4) Jannik Sinner  OR  (  1) Novak Djokovic
    TEAM.draw(mens_singles, '6.2').matchup(1, men.Medvedev, 2, men.Zverev).select(1,4)  # (  3) Daniil Medvedev  OR  (  6) Alexander Zverev
...
def womens_singles_round_5(womens_singles):
    ...
    TEAM.draw(womens_singles, '5.2').matchup(1, women.Zheng, 2, women.Kalinskaya).select(1,2)  # ( 12) Qinwen Zheng  OR  (   ) Anna Kalinskaya
    TEAM.draw(womens_singles, '5.3').matchup(1, women.Kostyuk, 2, women.Gauff).select(2,3)  # (   ) Marta Kostyuk  OR  (  4) Coco Gauff
    TEAM.draw(womens_singles, '5.4').matchup(1, women.Krejcikova, 2, women.Sabalenka).select(2,3)  # (  9) Barbora Krejcikova  OR  (  2) Aryna Sabalenka
...
def mens_singles_round_5(mens_singles):
    ...
    TEAM.draw(mens_singles, '5.2').matchup(1, men.Sinner, 2, men.Rublev).select(1,4)  # (  4) Jannik Sinner  OR  (  5) Andrey Rublev
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles).match('4.5').winner(women.Maria_Timofeeva).in_sets(3)  # (   ) Marta Kostyuk  OR  (  Q) Maria Timofeeva
    TEAM.draw(womens_singles).match('4.6').winner(women.Gauff).in_sets(3)  # (   ) Magdalena Frech  OR  (  4) Coco Gauff
    TEAM.draw(womens_singles).match('4.7').winner(women.Andreeva_Mirra).in_sets(2)  # (   ) Mirra Andreeva  OR  (  9) Barbora Krejcikova
...
def mens_singles_round_4(mens_singles):
    TEAM.draw(mens_singles).match('4.1').winner(men.Djokovic).in_sets(4)  # (  1) Novak Djokovic  OR  ( 20) Adrian Mannarino
    TEAM.draw(mens_singles).match('4.2').winner(men.Fritz).in_sets(4)  # ( 12) Taylor Fritz  OR  (  7) Stefanos Tsitsipas
    TEAM.draw(mens_singles).match('4.3').winner(men.Sinner).in_sets(4)  # (  4) Jannik Sinner  OR  ( 15) Karen Khachanov
    TEAM.draw(mens_singles).match('4.4').winner(men.Rublev).in_sets(4)  # (  5) Andrey Rublev  OR  ( 10) Alex de Minaur
...
def womens_singles_round_3(womens_singles):
    TEAM.draw(womens_singles, '3.1').matchup(1, women.Swiatek, 2, women.Noskova).select(2,3)  # (  1) Iga Swiatek  OR  (   ) Linda Noskova
    TEAM.draw(womens_singles, '3.2').matchup(1, women.Svitolina, 2, women.Golubic).select(1,2)  # ( 19) Svitolina  OR  (   ) Viktorija Golubic
    TEAM.draw(womens_singles, '3.3').matchup(1, women.Azarenka, 2, women.Ostapenko).select(1,2)  # ( 18) Victoria Azarenka  OR  ( 11) Jelena Ostapenko
    ...
    TEAM.draw(womens_singles, '3.8').matchup(1, women.Oceane_Dodin, 2, women.Burel).select(1,2)  # (   ) Oceane Dodin  OR  (   ) Clara Burel

...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles, '3.11').matchup(1, women.Frech, 2, women.Anastasia_Zakharova).select(1,3)  # (   ) Magdalena Frech  OR  (  Q) Anastasia Zakharova
    ...
    TEAM.draw(womens_singles, '3.15').matchup(1, women.Anisimova, 2, women.Badosa).select(1,3)  # (   ) Amanda Anisimova  OR  (   ) Paula Badosa
...
def mens_singles_round_3(mens_singles):
    TEAM.draw(mens_singles, '3.1').matchup(1, men.Etcheverry, 2, men.Djokovic).select(2,5)  # ( 30) Tomas Martin Etcheverry  OR  (  1) Novak Djokovic
    ...
    TEAM.draw(mens_singles, '3.4').matchup(1, men.Van_Assche, 2, men.Tsitsipas).select(2,5)  # (   ) Luca Van Assche  OR  (  7) Stefanos Tsitsipas

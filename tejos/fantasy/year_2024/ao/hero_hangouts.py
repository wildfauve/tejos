...
def mens_singles_round_6(mens_singles):
    TEAM.draw(mens_singles, '6.1').matchup(1, men.Sinner, 2, men.Djokovic).select(1,4)  # (  4) Jannik Sinner  OR  (  1) Novak Djokovic
...
def womens_singles_round_5(womens_singles):
    TEAM.draw(womens_singles, '5.1').matchup(1, women.Noskova, 2, women.Yastremska).select(1,3) # ( ) Linda Noskova OR ( Q) Dayana Yastremska

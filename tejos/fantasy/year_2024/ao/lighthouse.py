...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles, '4.6').matchup(1, women.Frech, 2, women.Gauff).select(1,3)  # (   ) Magdalena Frech  OR  (  4) Coco Gauff
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles, '4.4').matchup(1, men.Rublev, 2, men.Alex_de_Minaur).select(2,5)  # (  5) Andrey Rublev  OR  ( 10) Alex de Minaur
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles, '3.9').matchup(1, men.Cazaux, 2, men.Griekspoor).select(2,3)  # ( WC) Arthur Cazaux  OR  ( 28) Tallon Griekspoor
    ...
    TEAM.draw(mens_singles, '3.12').matchup(1, men.Medvedev, 2, men.Auger_Aliassime).select(1,5)  # (  3) Daniil Medvedev  OR  ( 27) Felix Auger-Aliassime

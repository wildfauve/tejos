...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles, '3.13').matchup(1, women.Andreeva_Mirra, 2, women.Parry).select(2,3)  # (   ) Mirra Andreeva  OR  (   ) Diane Parry
    ...
    TEAM.draw(womens_singles, '3.16').matchup(1, women.Sabalenka, 2, women.Tsurenko).select(1,3)  # (  2) Aryna Sabalenka  OR  ( 28) Lesia Tsurenko
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles, '3.2').matchup(1, men.Mannarino, 2, men.Shelton).select(2,5)  # ( 20) Adrian Mannarino  OR  ( 16) Ben Shelton
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles, '2.9').matchup(1, women.Blinkova, 2, women.Rybakina).select(2,3)  # (   ) Anna Blinkova  OR  (  3) Elena Rybakina

...
def mens_singles_round_7(mens_singles):
    TEAM.draw(mens_singles, '7.1').matchup(1, men.Medvedev, 2, men.Sinner).select(2,3)  # (  3) Daniil Medvedev  OR  (  4) Jannik Sinner
...
def womens_singles_round_5(womens_singles):
    TEAM.draw(womens_singles, '5.1').matchup(1, women.Noskova, 2, women.Yastremska).select(2,3) # ( ) Linda Noskova OR ( Q) Dayana Yastremska
...
def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles, '5.1').matchup(1, men.Djokovic, 2, men.Fritz).select(2,4) # ( 1) Novak Djokovic OR ( 12) Taylor Fritz
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles, '4.4').matchup(1, women.Zheng, 2, women.Oceane_Dodin).select(2,3)  # ( 12) Qinwen Zheng  OR  (   ) Oceane Dodin
...
def mens_singles_round_4(mens_singles):
    TEAM.draw(mens_singles, '4.1').matchup(1, men.Djokovic, 2, men.Mannarino).select(2,5)  # (  1) Novak Djokovic  OR  ( 20) Adrian Mannarino
    ...
    TEAM.draw(mens_singles, '4.5').matchup(1, men.Cazaux, 2, men.Hurkacz).select(1,4)  # ( WC) Arthur Cazaux  OR  (  9) Hubert Hurkacz
    TEAM.draw(mens_singles, '4.6').matchup(1, men.Medvedev, 2, men.Borges).select(1,3)  # (  3) Daniil Medvedev  OR  (   ) Nuno Borges
    TEAM.draw(mens_singles, '4.7').matchup(1, men.Norrie, 2, men.Zverev).select(1,4)  # ( 19) Cameron Norrie  OR  (  6) Alexander Zverev
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles, '3.3').matchup(1, men.Fritz, 2, men.Marozsan).select(2,4)  # ( 12) Taylor Fritz  OR  (   ) Fabian Marozsan
    ...
    TEAM.draw(mens_singles, '3.7').matchup(1, men.Flavio_Cobolli, 2, men.Alex_de_Minaur).select(1,3)  # (  Q) Flavio Cobolli  OR  ( 10) Alex de Minaur

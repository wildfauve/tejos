...
def womens_singles_round_1(womens_singles):
    ...
    TEAM.draw(womens_singles, '1.12').matchup(1, women.Giorgi, 2, women.Azarenka).select(1,3)  # (   ) Camila Giorgi  OR  ( 18) Victoria Azarenka
    ...
    TEAM.draw(womens_singles, '1.30').matchup(1, women.Renata_Zarazua, 2, women.Trevisan).select(2,3)  # (  Q) Renata Zarazua  OR  (   ) Martina Trevisan
...
def mens_singles_round_1(mens_singles):
    ...
    TEAM.draw(mens_singles, '1.4').matchup(1, men.Murray_Andy, 2, men.Etcheverry).select(1,3)  # (   ) Andy Murray  OR  ( 30) Tomas Martin Etcheverry
    ...
    TEAM.draw(mens_singles, '1.28').matchup(1, men.Flavio_Cobolli, 2, men.Jarry).select(1,4)  # (  Q) Flavio Cobolli  OR  ( 18) Nicolas Jarry
    ...
    TEAM.draw(mens_singles, '1.53').matchup(1, men.Norrie, 2, men.Varillas).select(1,4)  # ( 19) Cameron Norrie  OR  (   ) Juan Pablo Varillas
    TEAM.draw(mens_singles, '1.54').matchup(1, men.Lajovic, 2, men.Zeppieri).select(2,4)  # (   ) Dusan Lajovic  OR  (  Q) Giulio Zeppieri
    ...
    TEAM.draw(mens_singles, '1.58').matchup(1, men.Giron, 2, men.Draper).select(1,5)  # (   ) Marcos Giron  OR  (   ) Jack Draper

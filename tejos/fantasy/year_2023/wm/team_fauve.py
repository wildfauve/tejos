...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles).match('2.2').winner(women.Martic).in_sets(2)  # (   ) Parry  OR  ( 30) Martic
    TEAM.draw(womens_singles).match('2.3').winner(women.Linette).in_sets(3)  # ( 23) Linette  OR  (   ) Strycova
    TEAM.draw(womens_singles).match('2.4').winner(women).in_sets()  # (   ) Collins  OR  ( 14) Bencic
    TEAM.draw(womens_singles).match('2.5').winner(women.Kasatkina).in_sets(2)  # ( 11) Kasatkina  OR  ( WC) Burrage
    TEAM.draw(womens_singles).match('2.6').winner(women.Azarenka).in_sets(3)  # (   ) Podoroska  OR  ( 19) Azarenka
    TEAM.draw(womens_singles).match('2.7').winner(women.Mertens).in_sets(2)  # ( 28) Mertens  OR  ( WC) Svitolina
    TEAM.draw(womens_singles).match('2.8').winner(women.Wang_Xinyu).in_sets(2)  # (   ) Wang_Xinyu  OR  (  Q) Kenin
    TEAM.draw(womens_singles).match('2.9').winner(women.Pegula).in_sets(3)  # (  4) Pegula  OR  (   ) Bucsa
    TEAM.draw(womens_singles).match('2.10').winner(women.Cocciaretto).in_sets(3)  # (   ) Cocciaretto  OR  (   ) Masarova
    TEAM.draw(womens_singles).match('2.11').winner(women.Tsurenko).in_sets(3)  # (   ) Siniakova  OR  (   ) Tsurenko
    TEAM.draw(womens_singles).match('2.12').winner(women.Parks).in_sets(2)  # (   ) Parks  OR  (   ) Bogdan
    TEAM.draw(womens_singles).match('2.13').winner(women.Kudermetova_Veronika).in_sets(3)  # ( 12) Kudermetova_Veronika  OR  (   ) Vondrousova
    TEAM.draw(womens_singles).match('2.14').winner(women.Vekic).in_sets(3)  # (   ) Stephens  OR  ( 20) Vekic
    TEAM.draw(womens_singles).match('2.15').winner(women.Bouzkova).in_sets()  # ( 32) Bouzkova  OR  (   ) Kontaveit
    ...
    TEAM.draw(womens_singles).match('2.19').winner(women.Stevanovic).in_sets(3)  # (  Q) Stevanovic  OR  ( LL) Korpatsch
    ...
    TEAM.draw(womens_singles).match('2.22').winner(women.Ostapenko).in_sets()  # (   ) Cirstea  OR  ( 17) Ostapenko
    ...
    TEAM.draw(womens_singles).match('2.28').winner(women.Krejcikova).in_sets(2)  # (  Q) Andreeva_Mirra  OR  ( 10) Krejcikova
    TEAM.draw(womens_singles).match('2.29').winner(women).in_sets()  # TBD  OR  TBD
    TEAM.draw(womens_singles).match('2.30').winner(women.Alexandrova).in_sets(2)  # (   ) Brengle  OR  ( 21) Alexandrova

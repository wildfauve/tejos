...
def womens_singles_round_6(womens_singles):
    TEAM.draw(womens_singles, '6.1').matchup(1, women.Svitolina, 2, women.Vondrousova).select(2, 2)  # ( WC) Svitolina  OR  (   ) Marketa Vondrousova
    TEAM.draw(womens_singles, '6.2').matchup(1, women.Jabeur, 2, women.Sabalenka).select(2, 2)  # (  6) Ons Jabeur  OR  (  2) Aryna Sabalenka
# womens_singles_round_6:END


# mens_singles_round_6:START
def mens_singles_round_6(mens_singles):
    TEAM.draw(mens_singles, '6.1').matchup(1, men.Alcaraz, 2, men.Medvedev).select(1, 5)  # (  1) Carlos Alcaraz  OR  (  3) Daniil Medvedev
...
def womens_singles_round_5(womens_singles):
    TEAM.draw(womens_singles).match('5.1').winner(women.Swiatek).in_sets(3)  # (  1) Iga Swiatek  OR  ( WC) Svitolina
    TEAM.draw(womens_singles).match('5.2').winner(women.Pegula).in_sets(3)  # (  4) Jessica Pegula  OR  (   ) Marketa Vondrousova
    TEAM.draw(womens_singles, '5.3').matchup(1, women.Jabeur, 2, women.Rybakina).select(1, 3)  # (  6) Ons Jabeur  OR  (  3) Elena Rybakina
...
def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles, '5.1').matchup(1, men.Alcaraz, 2, men.Rune).select(1, 5)  # (  1) Carlos Alcaraz  OR  (  6) Holger Rune
    ...
    TEAM.draw(mens_singles, '5.4').matchup(1, men.Rublev, 2, men.Djokovic).select(2, 5)  # (  7) Andrey Rublev  OR  (  2) Novak Djokovic
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles).match('4.2').winner(women.Svitolina).in_sets(2)  # ( 19) Victoria Azarenka  OR  ( WC) Svitolina
    TEAM.draw(womens_singles).match('4.3').winner(women.Pegula).in_sets(2)  # (  4) Jessica Pegula  OR  (   ) Lesia Tsurenko
    TEAM.draw(womens_singles).match('4.4').winner(women.Vondrousova).in_sets(2)  # (   ) Marketa Vondrousova  OR  ( 32) Marie Bouzkova
    TEAM.draw(womens_singles).match('4.5').winner(women.Jabeur).in_sets(2)  # (  6) Ons Jabeur  OR  (  9) Petra Kvitova
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles).match('4.3').winner(men.Lehecka).in_sets(4)  # (  3) Daniil Medvedev  OR  (   ) Jiri Lehecka
    TEAM.draw(mens_singles).match('4.4').winner(men.Tsitsipas).in_sets(5)  # (   ) Christopher Eubanks  OR  (  5) Stefanos Tsitsipas
    TEAM.draw(mens_singles).match('4.5').winner(men.Sinner).in_sets(3)  # (  8) Jannik Sinner  OR  (   ) Daniel Elahi Galan
    TEAM.draw(mens_singles).match('4.6').winner(men.Shapovalov).in_sets(5)  # (   ) Roman Safiullin  OR  ( 26) Denis Shapovalov
...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles).match('3.15').winner(women.Alexandrova).in_sets(3)  # (   ) Galfi  OR  ( 21) Alexandrova
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles).match('3.2').winner(men.Zverev).in_sets(5)  # ( 19) Zverev  OR  (   ) Berrettini
    TEAM.draw(mens_singles).match('3.3').winner(men.Dimitrov).in_sets(4)  # ( 10) Frances Tiafoe  OR  ( 21) Grigor Dimitrov
    ...
    TEAM.draw(mens_singles).match('3.6').winner(men.Paul).in_sets(3)  # (   ) Jiri Lehecka  OR  ( 16) Tommy Paul
    TEAM.draw(mens_singles).match('3.7').winner(men.Eubanks).in_sets(4)  # (   ) Eubanks  OR  (   ) OConnell
    TEAM.draw(mens_singles).match('3.8').winner(men.Djere).in_sets(5)  # (   ) Djere  OR  (  5) Tsitsipas
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles).match('2.15').winner(women.Bouzkova).in_sets(2)  # ( 32) Marie Bouzkova  OR  (   ) Anett Kontaveit
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles).match('2.28').winner(men.Mmoh).in_sets(4)  # (  Q) Maximilian Marterer  OR  (   ) Michael Mmoh

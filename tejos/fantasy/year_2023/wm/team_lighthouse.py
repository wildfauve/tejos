...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles).match('3.5').winner(women.Pegula).in_sets(2)  # (  4) Pegula  OR  (   ) Cocciaretto
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles).match('3.3').winner(men.Dimitrov).in_sets(4)  # ( 10) Tiafoe  OR  ( 21) Dimitrov
    ...
    TEAM.draw(mens_singles).match('3.6').winner(men.Paul).in_sets(3)  # (   ) Lehecka  OR  ( 16) Paul

...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles).match('2.10').winner(women.Masarova).in_sets(3)  # (   ) Cocciaretto  OR  (   ) Masarova
    ...
    TEAM.draw(womens_singles).match('2.14').winner(women.Stephens).in_sets(3)  # (   ) Stephens  OR  ( 20) Vekic
    ...
    TEAM.draw(womens_singles).match('2.32').winner(women.Sabalenka).in_sets(3)  # (   ) Gracheva  OR  (  2) Sabalenka
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles).match('2.6').winner(men.Dimitrov).in_sets(3)  # (   ) Ivashka  OR  ( 21) Dimitrov
    ...
    TEAM.draw(mens_singles).match('2.9').winner(men.Medvedev).in_sets(5)  # (  3) Medvedev  OR  (   ) Mannarino
    TEAM.draw(mens_singles).match('2.10').winner(men.Giron).in_sets(4)  # (   ) Giron  OR  (   ) Fucsovics
    ...
    TEAM.draw(mens_singles).match('2.13').winner(men.Eubanks).in_sets(5)  # ( 12) Norrie  OR  (   ) Eubanks
    TEAM.draw(mens_singles).match('2.14').winner(men).in_sets()  # (   ) Vesely  OR  TBD
    TEAM.draw(mens_singles).match('2.15').winner(men.Djere).in_sets(4)  # ( 32) Shelton  OR  (   ) Djere
    TEAM.draw(mens_singles).match('2.16').winner(men.Murray_Andy).in_sets(4)  # (   ) Murray_Andy  OR  (  5) Tsitsipas
    ...
    TEAM.draw(mens_singles).match('2.22').winner(men.Safiullin).in_sets(4)  # (   ) Moutet  OR  (   ) Safiullin

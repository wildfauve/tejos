...
def mens_singles_round_1(mens_singles):
    ...
    TEAM.draw(mens_singles).match('1.52').winner(men).in_sets()  # ( WC) Goffin  OR  ( LL) Marozsan
    ...
    TEAM.draw(mens_singles).match('1.56').winner(men).in_sets()  # (   ) Mmoh  OR  ( 11) Auger_Aliassime

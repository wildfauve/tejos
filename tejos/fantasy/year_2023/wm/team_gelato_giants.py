...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles).match('3.4').winner(women.Svitolina).in_sets(3)  # ( WC) Svitolina  OR  (  Q) Kenin
    TEAM.draw(womens_singles).match('3.5').winner(women.Cocciaretto).in_sets(3)  # (  4) Pegula  OR  (   ) Cocciaretto
    TEAM.draw(womens_singles).match('3.6').winner(women.Bogdan).in_sets(2)  # (   ) Tsurenko  OR  (   ) Bogdan
    TEAM.draw(womens_singles).match('3.7').winner(women.Vekic).in_sets(3)  # (   ) Vondrousova  OR  ( 20) Vekic
    ...
    TEAM.draw(womens_singles).match('3.12').winner(women.Boulter).in_sets(3)  # ( WC) Boulter  OR  (  3) Rybakina
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles).match('3.3').winner(men.Tiafoe).in_sets(4)  # ( 10) Tiafoe  OR  ( 21) Dimitrov
    ...
    TEAM.draw(mens_singles).match('3.13').winner(men.Goffin).in_sets(4)  # (  7) Rublev  OR  ( WC) Goffin
    TEAM.draw(mens_singles).match('3.14').winner(men.Marterer).in_sets(5)  # ( 23) Bublik  OR  (  Q) Marterer

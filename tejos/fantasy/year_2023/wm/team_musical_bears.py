...
def womens_singles_round_5(womens_singles):
    TEAM.draw(womens_singles, '5.1').matchup(1, women.Swiatek, 2, women.Svitolina).select(1, 2)  # (  1) Iga Swiatek  OR  ( WC) Svitolina
    TEAM.draw(womens_singles, '5.2').matchup(1, women.Pegula, 2, women.Vondrousova).select(2, 3)  # (  4) Jessica Pegula  OR  (   ) Marketa Vondrousova
...
def mens_singles_round_5(mens_singles):
    ...
    TEAM.draw(mens_singles, '5.3').matchup(1, men.Sinner, 2, men.Safiullin).select(1, 3)  # (  8) Jannik Sinner  OR  (   ) Roman Safiullin

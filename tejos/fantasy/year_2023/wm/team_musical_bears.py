...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles).match('3.2').winner(women.Linette).in_sets(3)  # ( 23) Linette  OR  ( 14) Bencic
    ...
    TEAM.draw(womens_singles).match('3.8').winner(women.Garcia).in_sets(3)  # ( 32) Bouzkova  OR  (  5) Garcia
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles).match('3.9').winner(men.Sinner).in_sets(4)  # (  8) Sinner  OR  (   ) Halys
    TEAM.draw(mens_singles).match('3.10').winner(men.Ymer_Mikael).in_sets(4)  # (   ) Galan  OR  (   ) Ymer_Mikael
    TEAM.draw(mens_singles).match('3.11').winner(men.Pella).in_sets(4)  # (   ) Pella  OR  (   ) Safiullin
    TEAM.draw(mens_singles).match('3.12').winner(men.Shapovalov).in_sets(3)  # ( 26) Shapovalov  OR  ( WC) Broady
    TEAM.draw(mens_singles).match('3.13').winner(men.Rublev).in_sets(3)  # (  7) Rublev  OR  ( WC) Goffin
    TEAM.draw(mens_singles).match('3.14').winner(men.Bublik).in_sets(4)  # ( 23) Bublik  OR  (  Q) Marterer
    TEAM.draw(mens_singles).match('3.15').winner(men.Musetti).in_sets(5)  # ( 14) Musetti  OR  ( 17) Hurkacz
    TEAM.draw(mens_singles).match('3.16').winner(men.Djokovic).in_sets(3)  # (   ) Wawrinka  OR  (  2) Djokovic

...
def womens_singles_round_6(womens_singles):
    TEAM.draw(womens_singles, '6.1').matchup(1, women.Svitolina, 2, women.Vondrousova).select(1, 3)  # ( WC) Svitolina  OR  (   ) Marketa Vondrousova
...
def mens_singles_round_6(mens_singles):
    ...
    TEAM.draw(mens_singles, '6.2').matchup(1, men.Sinner, 2, men.Djokovic).select(2, 4)  # (  8) Jannik Sinner  OR  (  2) Novak Djokovic
...
def womens_singles_round_5(womens_singles):
    ...
    TEAM.draw(womens_singles, '5.4').matchup(1, women.Keys, 2, women.Sabalenka).select(2, 2)  # ( 25) Madison Keys  OR  (  2) Aryna Sabalenka
# womens_singles_round_5:END


# mens_singles_round_5:START
def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles, '5.1').matchup(1, men.Alcaraz, 2, men.Rune).select(1, 3)  # (  1) Carlos Alcaraz  OR  (  6) Holger Rune
    TEAM.draw(mens_singles, '5.2').matchup(1, men.Medvedev, 2, men.Eubanks).select(2, 4)  # (  3) Daniil Medvedev  OR  (   ) Christopher Eubanks
    TEAM.draw(mens_singles).match('5.3').winner(men.Sinner).in_sets(3)  # (  8) Jannik Sinner  OR  (   ) Roman Safiullin
    TEAM.draw(mens_singles, '5.4').matchup(1, men.Rublev, 2, men.Djokovic).select(2, 3)  # (  7) Andrey Rublev  OR  (  2) Novak Djokovic
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles).match('4.6').winner(women.Haddad_Maia).in_sets(3)  # ( 13) Beatriz Haddad Maia  OR  (  3) Elena Rybakina
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles).match('4.4').winner(men.Eubanks).in_sets(4)  # (   ) Christopher Eubanks  OR  (  5) Stefanos Tsitsipas
    ...
    TEAM.draw(mens_singles).match('4.8').winner(men.Djokovic).in_sets(4)  # ( 17) Hubert Hurkacz  OR  (  2) Novak Djokovic
...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles).match('3.2').winner(women.Linette).in_sets(3)  # ( 23) Magda Linette  OR  ( 14) Belinda Bencic
    ...
    TEAM.draw(womens_singles).match('3.9').winner(women.Jabeur).in_sets()  # (  6) Jabeur  OR  (   ) Andreescu
    ...
    TEAM.draw(womens_singles).match('3.13').winner(women.Kostyuk).in_sets(3)  # (   ) Kostyuk  OR  ( 25) Keys
...
def mens_singles_round_3(mens_singles):
    TEAM.draw(mens_singles).match('3.1').winner(men.Alcaraz).in_sets(4)  # (  1) Alcaraz  OR  ( 25) Jarry
    TEAM.draw(mens_singles).match('3.2').winner(men.Berrettini).in_sets(4)  # ( 19) Zverev  OR  (   ) Berrettini
    TEAM.draw(mens_singles).match('3.3').winner(men.Tiafoe).in_sets(5)  # ( 10) Frances Tiafoe  OR  ( 21) Grigor Dimitrov
    TEAM.draw(mens_singles).match('3.4').winner(men.Rune).in_sets(5)  # ( 31) Davidovich_Fokina  OR  (  6) Rune
    ...
    TEAM.draw(mens_singles).match('3.7').winner(men.OConnell).in_sets(5)  # (   ) Eubanks  OR  (   ) OConnell
    ...
    TEAM.draw(mens_singles).match('3.10').winner(men.Ymer_Mikael).in_sets(4)  # (   ) Daniel Elahi Galan  OR  (   ) Mikael Ymer
    ...
    TEAM.draw(mens_singles).match('3.13').winner(men.Rublev).in_sets(3)  # (  7) Andrey Rublev  OR  ( WC) David Goffin
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles).match('2.4').winner(women.Bencic).in_sets(3)  # (   ) Danielle Collins  OR  ( 14) Belinda Bencic
    ...
    TEAM.draw(womens_singles).match('2.10').winner(women.Masarova).in_sets(3)  # (   ) Elisabetta Cocciaretto  OR  (   ) Rebeka Masarova
    TEAM.draw(womens_singles).match('2.11').winner(women.Tsurenko).in_sets(3)  # (   ) Katerina Siniakova  OR  (   ) Lesia Tsurenko
    ...
    TEAM.draw(womens_singles).match('2.15').winner(women.Bouzkova).in_sets(2)  # ( 32) Bouzkova  OR  (   ) Kontaveit
    ...
    TEAM.draw(womens_singles).match('2.18').winner(women.Kalinina).in_sets(2)  # (   ) Andreescu  OR  ( 26) Kalinina
    ...
    TEAM.draw(womens_singles).match('2.22').winner(women.Ostapenko).in_sets(2)  # (   ) Sorana Cirstea  OR  ( 17) Jelena Ostapenko
    ...
    TEAM.draw(womens_singles).match('2.25').winner(women.Kostyuk).in_sets(3)  # (   ) Marta Kostyuk  OR  (   ) Paula Badosa
    ...
    TEAM.draw(womens_singles).match('2.30').winner(women.Alexandrova).in_sets(2)  # (   ) Madison Brengle  OR  ( 21) Ekaterina Alexandrova
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles).match('2.9').winner(men.Medvedev).in_sets(4)  # (  3) Daniil Medvedev  OR  (   ) Adrian Mannarino
    ...
    TEAM.draw(mens_singles).match('2.13').winner(men.Norrie).in_sets(4)  # ( 12) Cameron Norrie  OR  (   ) Christopher Eubanks
    ...
    TEAM.draw(mens_singles).match('2.16').winner(men.Tsitsipas).in_sets(4)  # (   ) Andy Murray  OR  (  5) Stefanos Tsitsipas
    ...
    TEAM.draw(mens_singles).match('2.22').winner(men.Safiullin).in_sets(4)  # (   ) Corentin Moutet  OR  (   ) Roman Safiullin
    TEAM.draw(mens_singles).match('2.23').winner(men.Shapovalov).in_sets(4)  # ( 26) Denis Shapovalov  OR  (   ) Gregoire Barrere

...
def mens_singles_round_7(mens_singles):
    TEAM.draw(mens_singles).match('7.1').winner(men.Djokovic).in_sets(5)  # (  3) Djokovic  OR  (  4) Ruud
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles).match('4.4').winner(men.Khachanov).in_sets(3)  # ( 11) Khachanov  OR  (   ) Sonego

    TEAM.draw(mens_singles).match('4.5').winner(men.Rune).in_sets(4)  # (  6) Rune  OR  ( 23) Cerundolo_Francisco
    TEAM.draw(mens_singles).match('4.6').winner(men.Ruud).in_sets(5)  # (   ) Jarry  OR  (  4) Ruud
    TEAM.draw(mens_singles).match('4.7').winner(men.Dimitrov).in_sets(4)  # ( 28) Dimitrov  OR  ( 22) Zverev
    TEAM.draw(mens_singles).match('4.8').winner(men.Nishioka).in_sets(5)  # (   ) Etcheverry  OR  ( 27) Nishioka
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles).match('4.3').winner(women.Haddad_Maia).in_sets(
        3)  # (   ) Sorribes_Tormo  OR  ( 14) Haddad_Maia
    TEAM.draw(womens_singles).match('4.4').winner(women.Jabeur).in_sets(3)  # (   ) Pera  OR  (  7) Jabeur

    TEAM.draw(womens_singles).match('4.5').winner(women.Muchova).in_sets(2)  # (   ) Muchova  OR  (  L) Avanesyan
    TEAM.draw(womens_singles).match('4.6').winner(women.Pavlyuchenkova).in_sets(
        3)  # (   ) Pavlyuchenkova  OR  ( 28) Mertens
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles).match('3.3').winner(men.Fognini).in_sets(3)  # (   ) Fognini  OR  (  Q) Ofner
    ...
    TEAM.draw(mens_singles).match('3.12').winner(men.Ruud).in_sets(4)  # (   ) Zhang_Zhizhen  OR  (  4) Ruud
    TEAM.draw(mens_singles).match('3.13').winner(men.Dimitrov).in_sets(4)  # (   ) Altmaier  OR  ( 28) Dimitrov
    TEAM.draw(mens_singles).match('3.14').winner(men.Tiafoe).in_sets(5)  # ( 22) Zverev  OR  ( 12) Tiafoe
    TEAM.draw(mens_singles).match('3.15').winner(men.Coric).in_sets(4)  # ( 15) Coric  OR  (   ) Etcheverry
    TEAM.draw(mens_singles).match('3.16').winner(men.Seyboth_Wild).in_sets(5)  # ( 27) Nishioka  OR  (  Q) Seyboth_Wild
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles).match('2.11').winner(men.Bautista_Agut).in_sets(
        3)  # ( 19) Bautista_Agut  OR  (   ) Varillas
    ...
    TEAM.draw(mens_singles).match('2.19').winner(men.Cerundolo_Francisco).in_sets(
        3)  # ( 23) Cerundolo_Francisco  OR  (  L) Hanfmann
    TEAM.draw(mens_singles).match('2.20').winner(men.Fritz).in_sets(4)  # (   ) Rinderknech  OR  (  9) Fritz
    ...
    TEAM.draw(mens_singles).match('2.29').winner(men.Coric).in_sets(3)  # ( 15) Coric  OR  (   ) Cachin
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles).match('2.17').winner(women.Podoroska).in_sets(3)  # (   ) Muchova  OR  (   ) Podoroska
    ...
    TEAM.draw(womens_singles).match('2.22').winner(women.Potapova).in_sets(2)  # (   ) Sherif  OR  ( 24) Potapova
    TEAM.draw(womens_singles).match('2.23').winner(women.Osorio).in_sets(3)  # ( 28) Mertens  OR  (  L) Osorio
    TEAM.draw(womens_singles).match('2.24').winner(women.Pegula).in_sets(2)  # (   ) Giorgi  OR  (  3) Pegula
    TEAM.draw(womens_singles).match('2.25').winner(women.Garcia).in_sets(2)  # (  5) Garcia  OR  (   ) Blinkova
    ...
    TEAM.draw(womens_singles).match('2.28').winner(women.Kasatkina).in_sets(3)  # (   ) Vondrousova  OR  (  9) Kasatkina
    ...
    TEAM.draw(womens_singles).match('2.31').winner(women.Rakhimova).in_sets(3)  # (   ) Frech  OR  (   ) Rakhimova
...
def womens_singles_round_1(womens_singles):
    ...
    TEAM.draw(womens_singles).match('1.34').winner(women.Ponchet).in_sets(
    ...
    TEAM.draw(womens_singles).match('1.41').winner(
        women.Samsonova).in_sets(3)  # ( 15) Liudmila Samsonova  OR  (   ) Katie Volynets
    TEAM.draw(womens_singles).match('1.42').winner(
        women.Pavlyuchenkova).in_sets(3)  # (   ) Anastasia Pavlyuchenkova  OR  (   ) Linda Fruhvirtova
    ...
    TEAM.draw(womens_singles).match('1.50').winner(
        women.Blinkova).in_sets(3)  # (   ) Anna Blinkova  OR  (   ) Ysaline Bonaventure
    ...
    TEAM.draw(womens_singles).match('1.54').winner(
        women.Stearns).in_sets(3)  # (   ) Peyton Stearns  OR  (   ) Katerina Siniakova
    ...
    TEAM.draw(womens_singles).match('1.63').winner(women.Shymanovich).in_sets(

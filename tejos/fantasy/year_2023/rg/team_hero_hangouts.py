...
def womens_singles_round_6(womens_singles):
    TEAM.draw(womens_singles).match('6.1').winner(women.Swiatek).in_sets(3)  # (  1) Swiatek  OR  ( 14) Haddad_Maia
    TEAM.draw(womens_singles).match('6.2').winner(women.Muchova).in_sets(3)  # (   ) Muchova  OR  (  2) Sabalenka


def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles).match('5.1').winner(men.Alcaraz).in_sets(4)  # (  1) Alcaraz  OR  (  5) Tsitsipas
    TEAM.draw(mens_singles).match('5.2').winner(men.Djokovic).in_sets(3)  # (  3) Djokovic  OR  ( 11) Khachanov
    TEAM.draw(mens_singles).match('5.3').winner(men.Ruud).in_sets(4)  # (  6) Rune  OR  (  4) Ruud
    TEAM.draw(mens_singles).match('5.4').winner(men.Etcheverry).in_sets(4)  # ( 22) Zverev  OR  (   ) Etcheverry
...
def womens_singles_round_5(womens_singles):
    ...
    TEAM.draw(womens_singles).match('5.2').winner(women.Haddad_Maia).in_sets(3)  # ( 14) Haddad_Maia  OR  (  7) Jabeur
    TEAM.draw(womens_singles).match('5.3').winner(women.Pavlyuchenkova).in_sets(
        3)  # (   ) Muchova  OR  (   ) Pavlyuchenkova
    TEAM.draw(womens_singles).match('5.4').winner(women.Sabalenka).in_sets(3)  # (   ) Svitolina  OR  (  2) Sabalenka
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles).match('4.8').winner(men.Etcheverry).in_sets(3)  # (   ) Etcheverry  OR  ( 27) Nishioka
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles).match('4.7').winner(women.Kasatkina).in_sets(2)  # (   ) Svitolina  OR  (  9) Kasatkina
    TEAM.draw(womens_singles).match('4.8').winner(women.Sabalenka).in_sets(2)  # (   ) Stephens  OR  (  2) Sabalenka
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles).match('3.2').winner(men.Norrie).in_sets(5)  # ( 17) Musetti  OR  ( 14) Norrie
    ...
    TEAM.draw(mens_singles).match('3.6').winner(men.Varillas).in_sets(5)  # (   ) Varillas  OR  ( 13) Hurkacz
    TEAM.draw(mens_singles).match('3.7').winner(men.Khachanov).in_sets(3)  # ( 11) Khachanov  OR  (  W) Kokkinakis
    TEAM.draw(mens_singles).match('3.8').winner(men.Rublev).in_sets(5)  # (   ) Sonego  OR  (  7) Rublev
    TEAM.draw(mens_singles).match('3.9').winner(men.Rune).in_sets(4)  # (  6) Rune  OR  (  Q) Olivieri
    TEAM.draw(mens_singles).match('3.10').winner(men.Fritz).in_sets(5)  # ( 23) Cerundolo_Francisco  OR  (  9) Fritz
    TEAM.draw(mens_singles).match('3.11').winner(men.Giron).in_sets(5)  # (   ) Jarry  OR  (   ) Giron
    TEAM.draw(mens_singles).match('3.12').winner(men.Ruud).in_sets(5)  # (   ) Zhang_Zhizhen  OR  (  4) Ruud
    TEAM.draw(mens_singles).match('3.13').winner(men.Dimitrov).in_sets(4)  # (   ) Altmaier  OR  ( 28) Dimitrov
    TEAM.draw(mens_singles).match('3.14').winner(men.Zverev).in_sets(4)  # ( 22) Zverev  OR  ( 12) Tiafoe
    TEAM.draw(mens_singles).match('3.15').winner(men.Coric).in_sets(3)  # ( 15) Coric  OR  (   ) Etcheverry
    TEAM.draw(mens_singles).match('3.16').winner(men.Nishioka).in_sets(3)  # ( 27) Nishioka  OR  (  Q) Seyboth_Wild
    return TEAM
...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles).match('3.2').winner(women.Tsurenko).in_sets(3)  # (   ) Andreescu  OR  (   ) Tsurenko
    TEAM.draw(womens_singles).match('3.3').winner(women.Day).in_sets(3)  # (   ) Schmiedlova  OR  (  Q) Day
    TEAM.draw(womens_singles).match('3.4').winner(women.Andreeva_Mirra).in_sets(
        2)  # (  Q) Andreeva_Mirra  OR  (  6) Gauff
    TEAM.draw(womens_singles).match('3.5').winner(women.Sorribes_Tormo).in_sets(
        2)  # (  4) Rybakina  OR  (   ) Sorribes_Tormo
    TEAM.draw(womens_singles).match('3.6').winner(women.Alexandrova).in_sets(
        2)  # ( 23) Alexandrova  OR  ( 14) Haddad_Maia
    TEAM.draw(womens_singles).match('3.7').winner(women.Pera).in_sets(2)  # (   ) Cocciaretto  OR  (   ) Pera
    TEAM.draw(womens_singles).match('3.8').winner(women.Jabeur).in_sets(3)  # (  Q) Danilovic  OR  (  7) Jabeur
    TEAM.draw(womens_singles).match('3.9').winner(women.Begu).in_sets(3)  # (   ) Muchova  OR  ( 27) Begu
    ...
    TEAM.draw(womens_singles).match('3.12').winner(women.Pegula).in_sets(2)  # ( 28) Mertens  OR  (  3) Pegula
    TEAM.draw(womens_singles).match('3.13').winner(women.Svitolina).in_sets(3)  # (   ) Blinkova  OR  (   ) Svitolina
    TEAM.draw(womens_singles).match('3.14').winner(women.Stearns).in_sets(2)  # (   ) Stearns  OR  (  9) Kasatkina
    TEAM.draw(womens_singles).match('3.15').winner(women.Putintseva).in_sets(3)  # (   ) Stephens  OR  (   ) Putintseva
    TEAM.draw(womens_singles).match('3.16').winner(women.Sabalenka).in_sets(3)  # (   ) Rakhimova  OR  (  2) Sabalenka


def mens_singles_round_2(mens_singles):
    TEAM.draw(mens_singles).match('2.1').winner(men.Alcaraz).in_sets(3)  # (  1) Alcaraz  OR  (   ) Daniel
    TEAM.draw(mens_singles).match('2.2').winner(men.Arnaldi).in_sets(3)  # (   ) Arnaldi  OR  ( 26) Shapovalov
    TEAM.draw(mens_singles).match('2.3').winner(men.Musetti).in_sets(5)  # ( 17) Musetti  OR  (   ) Shevchenko
    TEAM.draw(mens_singles).match('2.4').winner(men.Norrie).in_sets(5)  # (  Q) Pouille  OR  ( 14) Norrie
    ...
    TEAM.draw(mens_singles).match('2.15').winner(men.Sonego).in_sets(5)  # (   ) Sonego  OR  (   ) Humbert
    ...
    TEAM.draw(mens_singles).match('2.20').winner(men.Rinderknech).in_sets(3)  # (   ) Rinderknech  OR  (  9) Fritz
    TEAM.draw(mens_singles).match('2.21').winner(men.Jarry).in_sets(4)  # ( 16) Paul  OR  (   ) Jarry
    TEAM.draw(mens_singles).match('2.22').winner(men.Lehecka).in_sets(5)  # (   ) Giron  OR  (   ) Lehecka
    TEAM.draw(mens_singles).match('2.23').winner(men.Tirante).in_sets(5)  # (  Q) Tirante  OR  (   ) Zhang_Zhizhen
    TEAM.draw(mens_singles).match('2.24').winner(men.Zeppieri).in_sets(4)  # (  Q) Zeppieri  OR  (  4) Ruud
    TEAM.draw(mens_singles).match('2.25').winner(men.Sinner).in_sets(3)  # (  8) Sinner  OR  (   ) Altmaier
    TEAM.draw(mens_singles).match('2.26').winner(men.Dimitrov).in_sets(3)  # (   ) Ruusuvuori  OR  ( 28) Dimitrov
    TEAM.draw(mens_singles).match('2.27').winner(men.Molcan).in_sets(5)  # ( 22) Zverev  OR  (   ) Molcan
    TEAM.draw(mens_singles).match('2.28').winner(men.Tiafoe).in_sets(4)  # (  Q) Karatsev  OR  ( 12) Tiafoe
    TEAM.draw(mens_singles).match('2.29').winner(men.Cachin).in_sets(5)  # ( 15) Coric  OR  (   ) Cachin
    TEAM.draw(mens_singles).match('2.30').winner(men.Etcheverry).in_sets(5)  # (   ) Etcheverry  OR  ( 18) De_Minaur
    TEAM.draw(mens_singles).match('2.31').winner(men.Purcell).in_sets(5)  # ( 27) Nishioka  OR  (   ) Purcell
    TEAM.draw(mens_singles).match('2.32').winner(men.Seyboth_Wild).in_sets(5)  # (   ) Pella  OR  (  Q) Seyboth_Wild
    return TEAM


def womens_singles_round_2(womens_singles):
    TEAM.draw(womens_singles).match('2.1').winner(women.Liu).in_sets(2)  # (  1) Swiatek  OR  (   ) Liu
    TEAM.draw(womens_singles).match('2.2').winner(women.Peterson).in_sets(3)  # (   ) Peterson  OR  (   ) Wang_Xinyu
    TEAM.draw(womens_singles).match('2.3').winner(women.Andreescu).in_sets(3)  # (   ) Andreescu  OR  (  W) Navarro
    ...
    TEAM.draw(womens_singles).match('2.13').winner(women.Cocciaretto).in_sets(3)  # (   ) Cocciaretto  OR  (  Q) Waltert
    TEAM.draw(womens_singles).match('2.14').winner(women.Pera).in_sets(2)  # (   ) Pera  OR  ( 22) Vekic
    TEAM.draw(womens_singles).match('2.15').winner(women.Paolini).in_sets(3)  # (   ) Paolini  OR  (  Q) Danilovic
    TEAM.draw(womens_singles).match('2.16').winner(women.Dodin).in_sets(3)  # (   ) Dodin  OR  (  7) Jabeur
    TEAM.draw(womens_singles).match('2.17').winner(women.Muchova).in_sets(2)  # (   ) Muchova  OR  (   ) Podoroska
...
def mens_singles_round_1(mens_singles):
    ...
    TEAM.draw(mens_singles).match('1.2').winner(men.OConnell).in_sets(
        5)  # (   ) Christopher O'Connell  OR  (   ) Taro Daniel
    TEAM.draw(mens_singles).match('1.3').winner(men.Arnaldi).in_sets(
        5)  # (   ) Matteo Arnaldi  OR  (   ) Daniel Elahi Galan
    ...
    TEAM.draw(mens_singles).match('1.9').winner(men.Fognini).in_sets(
        4)  # ( 10) Felix Auger-Aliassime  OR  (   ) Fabio Fognini
    TEAM.draw(mens_singles).match('1.10').winner(men.Kubler).in_sets(5)  # (   ) Jason Kubler  OR  (  L) Diaz Acosta
    ...
    TEAM.draw(mens_singles).match('1.12').winner(men.Korda).in_sets(
        4)  # (   ) Mackenzie McDonald  OR  ( 24) Sebastian Korda
    TEAM.draw(mens_singles).match(
        '1.13').winner(men.Zapata_Miralles).in_sets(5)  # ( 32) Bernabe Zapata Miralles  OR  (   ) Diego Schwartzman
    ...
    TEAM.draw(mens_singles).match('1.18').winner(men.Fucsovics).in_sets(
        5)  # (   ) Marton Fucsovics  OR  (  W) Hugo Grenier
    TEAM.draw(mens_singles).match('1.19').winner(men.Cecchinato).in_sets(
        4)  # (   ) Luca Van Assche  OR  (   ) Marco Cecchinato
    TEAM.draw(mens_singles).match('1.20').winner(men.Davidovich_Fokina).in_sets(
        3)  # (  W) Arthur Fils  OR  ( 29) Alejandro Davidovich Fokina
    ...
    TEAM.draw(mens_singles).match('1.22').winner(men.Varillas).in_sets(
        5)  # (  Q) Juncheng Shang  OR  (   ) Juan Pablo Varillas
    TEAM.draw(mens_singles).match('1.23').winner(men.Griekspoor).in_sets(
        3)  # (  Q) Pedro Martinez  OR  (   ) Tallon Griekspoor
    TEAM.draw(mens_singles).match('1.24').winner(men.Hurkacz).in_sets(4)  # (   ) David Goffin  OR  ( 13) Hubert Hurkacz
    TEAM.draw(mens_singles).match('1.25').winner(men.Khachanov).in_sets(
        4)  # ( 11) Karen Khachanov  OR  (   ) Constant Lestienne
    ...
    TEAM.draw(mens_singles).match('1.33').winner(men.Rune).in_sets(
        4)  # (  6) Holger Rune  OR  (   ) Christopher Eubanks
    TEAM.draw(mens_singles).match('1.34').winner(men.Monfils).in_sets(5)  # (   ) Gael Monfils  OR  (   ) Sebastian Baez
    TEAM.draw(mens_singles).match('1.35').winner(men.Mpetshi_Perricard).in_sets(
        4)  # (  W) G.Mpetshi Perricard  OR  (  Q) GA.Olivieri
    TEAM.draw(mens_singles).match('1.36').winner(men.Vavassori).in_sets(
        4)  # (  Q) Andrea Vavassori  OR  ( 31) Miomir Kecmanovic
    TEAM.draw(mens_singles).match('1.37').winner(men.Cerundolo_Francisco).in_sets(
        4)  # ( 23) Francisco Cerundolo  OR  (   ) Jaume Munar
    ...
    TEAM.draw(mens_singles).match('1.39').winner(men.Gasquet).in_sets(
        5)  # (   ) Richard Gasquet  OR  (   ) Arthur Rinderknech
    TEAM.draw(mens_singles).match('1.40').winner(men.Fritz).in_sets(5)  # (   ) Michael Mmoh  OR  (  9) Taylor Fritz
    TEAM.draw(mens_singles).match('1.41').winner(men.Paul).in_sets(4)  # ( 16) Tommy Paul  OR  (  L) D.Stricker
    TEAM.draw(mens_singles).match('1.42').winner(men.Dellien).in_sets(4)  # (   ) Nicolas Jarry  OR  (   ) Hugo Dellien
    ...
    TEAM.draw(mens_singles).match('1.44').winner(men.Struff).in_sets(
        3)  # (   ) Jiri Lehecka  OR  ( 21) Jan-Lennard Struff
    ...
    TEAM.draw(mens_singles).match('1.47').winner(men.Zeppieri).in_sets(
        5)  # (   ) Alexander Bublik  OR  (  Q) Giulio Zeppieri
    ...
    TEAM.draw(mens_singles).match('1.50').winner(men.Huesler).in_sets(
        3)  # (   ) Daniel Altmaier  OR  (   ) Marc-Andrea Huesler
    TEAM.draw(mens_singles).match('1.51').winner(men.Barrere).in_sets(
        3)  # (   ) Emil Ruusuvuori  OR  (   ) Gregoire Barrere
    TEAM.draw(mens_singles).match('1.52').winner(men.Dimitrov).in_sets(
        3)  # (  Q) Timofey Skatov  OR  ( 28) Grigor Dimitrov
    TEAM.draw(mens_singles).match('1.53').winner(men.Zverev).in_sets(
        5)  # ( 22) Alexander Zverev  OR  (   ) Lloyd Harris
    TEAM.draw(mens_singles).match('1.54').winner(men.Gaston).in_sets(5)  # (  W) Hugo Gaston  OR  (   ) Alex Molcan
    ...
    TEAM.draw(mens_singles).match('1.57').winner(men.Coric).in_sets(
        3)  # ( 15) Borna Coric  OR  (   ) Federico Coria    TEAM.draw(mens_singles).match('1.58').winner(men.Thiem).in_sets(4)  # (   ) Dominic Thiem  OR  (   ) Pedro Cachin
    TEAM.draw(mens_singles).match('1.59').winner(men.Draper).in_sets(
        3)  # (   ) Jack Draper  OR  (   ) Tomas Martin Etcheverry
    TEAM.draw(mens_singles).match('1.60').winner(men.De_Minaur).in_sets(
        3)  # (   ) Ilya Ivashka  OR  ( 18) Alex De Minaur
    ...
    TEAM.draw(mens_singles).match('1.63').winner(men.Halys).in_sets(3)  # (   ) Quentin Halys  OR  (   ) Guido Pella
    TEAM.draw(mens_singles).match('1.64').winner(men.Medvedev).in_sets(
        4)  # (  Q) T.Seyboth Wild  OR  (  2) Daniil Medvedev
...
def womens_singles_round_1(womens_singles):
    ...
    TEAM.draw(womens_singles).match('1.5').winner(women.Azarenka).in_sets(
        2)  # ( 18) Victoria Azarenka  OR  (   ) Bianca Andreescu
    TEAM.draw(womens_singles).match('1.6').winner(women.Andreeva_Erika).in_sets(
        3)  # (   ) Andreeva_Erika  OR  (  W) Emma Navarro
    TEAM.draw(womens_singles).match('1.7').winner(women.Zhu).in_sets(2)  # (   ) Lin Zhu  OR  (   ) Lauren Davis
    ...
    TEAM.draw(womens_singles).match(
        '1.9').winner(women.Kudermetova_Veronika).in_sets(
        2)  # ( 11) Veronika Kudermetova  OR  (   ) Anna Karolina Schmiedlova
    ...
    TEAM.draw(womens_singles).match('1.13').winner(women.Parry).in_sets(
    ...
    TEAM.draw(womens_singles).match('1.17').winner(women.Rybakina).in_sets(
        2)  # (  4) Elena Rybakina  OR  (  Q) Brenda Fruhvirtova
    TEAM.draw(womens_singles).match('1.18').winner(women.Noskova).in_sets(
        2)  # (   ) Linda Noskova  OR  (   ) Danka Kovinic
    TEAM.draw(womens_singles).match('1.19').winner(women.Burel).in_sets(
        2)  # (  W) Clara Burel  OR  (   ) Sorribes Tormo
    TEAM.draw(womens_singles).match('1.20').winner(women.Rogers).in_sets(
        3)  # (   ) Petra Martic  OR  ( 32) Shelby Rogers
    TEAM.draw(womens_singles).match(
    ...
    TEAM.draw(womens_singles).match('1.22').winner(women.Friedsam).in_sets(
        3)  # (  L) Nao Hibino  OR  (   ) Anna-Lena Friedsam
    TEAM.draw(womens_singles).match('1.23').winner(women.Marino).in_sets(
        3)  # (   ) Rebecca Marino  OR  (   ) Diana Shnaider
    TEAM.draw(womens_singles).match('1.24').winner(women.Haddad_Maia).in_sets(
        3)  # (   ) Tatjana Maria  OR  ( 14) Beatriz Haddad Maia
    TEAM.draw(womens_singles).match('1.25').winner(women.Cocciaretto).in_sets(
        2)  # ( 10) Petra Kvitova  OR  (   ) Elisabetta Cocciaretto
    ...
    TEAM.draw(womens_singles).match('1.28').winner(women.Vekic).in_sets(
        3)  # (  Q) Dayana Yastremska  OR  ( 22) Donna Vekic
    TEAM.draw(womens_singles).match('1.29').winner(women.Paolini).in_sets(
    ...
    TEAM.draw(womens_singles).match('1.31').winner(women.Dodin).in_sets(3)  # (  W) Selena Janicijevic  OR  (   ) Dodin
    TEAM.draw(womens_singles).match('1.32').winner(women.Bronzetti).in_sets(
        2)  # (   ) Lucia Bronzetti  OR  (  7) Ons Jabeur
    TEAM.draw(womens_singles).match('1.33').winner(women.Sakkari).in_sets(
        3)  # (  8) Maria Sakkari  OR  (   ) Karolina Muchova
    TEAM.draw(womens_singles).match('1.34').winner(women.Ponchet).in_sets(3)  # (   ) Nadia Podoroska  OR  (  W) Ponchet
    TEAM.draw(womens_singles).match('1.35').winner(women.Errani).in_sets(
        3)  # (   ) Sara Errani  OR  (   ) Jil Teichmann
    TEAM.draw(womens_singles).match('1.36').winner(women.Bondar).in_sets(
        3)  # (   ) Anna Bondar  OR  ( 27) Irina-Camelia Begu
    TEAM.draw(womens_singles).match('1.37').winner(women.Linette).in_sets(
        3)  # ( 21) Magda Linette  OR  (   ) Leylah Fernandez
    TEAM.draw(womens_singles).match('1.38').winner(women.Sasnovich).in_sets(
        3)  # (  Q) C.Tauson  OR  (   ) Aliaksandra Sasnovich
    ...
    TEAM.draw(womens_singles).match('1.40').winner(women.Bencic).in_sets(
        3)  # (  L) Elina Avanesyan  OR  ( 12) Belinda Bencic
    TEAM.draw(womens_singles).match('1.41').winner(women.Samsonova).in_sets(
        3)  # ( 15) Liudmila Samsonova  OR  (   ) Katie Volynets
    TEAM.draw(womens_singles).match(
        '1.42').winner(women.Fruhvirtova_Linda).in_sets(
        2)  # (   ) Anastasia Pavlyuchenkova  OR  (   ) Linda Fruhvirtova
    TEAM.draw(womens_singles).match('1.43').winner(women.Sherif).in_sets(
        3)  # (   ) Mayar Sherif  OR  (   ) Madison Brengle
    TEAM.draw(womens_singles).match('1.44').winner(women.Potapova).in_sets(
        3)  # (  Q) Taylor Townsend  OR  ( 24) Anastasia Potapova
    TEAM.draw(womens_singles).match('1.45').winner(women.Mertens).in_sets(
        3)  # ( 28) Elise Mertens  OR  (  L) V.Hruncakova
    ...
    TEAM.draw(womens_singles).match('1.48').winner(women.Pegula).in_sets(
        3)  # (   ) Danielle Collins  OR  (  3) Jessica Pegula
    TEAM.draw(womens_singles).match('1.49').winner(women.Garcia).in_sets(
        3)  # (  5) Caroline Garcia  OR  (   ) Xinyu Wang
    TEAM.draw(womens_singles).match('1.50').winner(women.Bonaventure).in_sets(
        2)  # (   ) Anna Blinkova  OR  (   ) Ysaline Bonaventure
    TEAM.draw(womens_singles).match('1.51').winner(women.Parrizas_Diaz).in_sets(
        3)  # (   ) Nuria Parrizas Diaz  OR  (  Q) Storm Hunter
    TEAM.draw(womens_singles).match('1.52').winner(women.Trevisan).in_sets(
        3)  # (   ) Svitolina  OR  ( 26) Martina Trevisan
    TEAM.draw(womens_singles).match('1.53').winner(women.Ostapenko).in_sets(
        2)  # ( 17) Jelena Ostapenko  OR  (   ) Tereza Martincova
    TEAM.draw(womens_singles).match('1.54').winner(women.Siniakova).in_sets(
        3)  # (   ) Peyton Stearns  OR  (   ) Katerina Siniakova
    TEAM.draw(womens_singles).match('1.55').winner(women.Parks).in_sets(
        3)  # (   ) Marketa Vondrousova  OR  (   ) Alycia Parks
    TEAM.draw(womens_singles).match('1.56').winner(women.Kasatkina).in_sets(
        3)  # (   ) Jule Niemeier  OR  (  9) Daria Kasatkina
    TEAM.draw(womens_singles).match('1.57').winner(women.Pliskova).in_sets(
        3)  # ( 16) Karolina Pliskova  OR  (   ) Sloane Stephens
    TEAM.draw(womens_singles).match('1.58').winner(women.Galfi).in_sets(
        3)  # (   ) Varvara Gracheva  OR  (   ) Dalma Galfi
    TEAM.draw(womens_singles).match('1.59').winner(women.Zanevska).in_sets(
        3)  # (   ) Yulia Putintseva  OR  (   ) Maryna Zanevska
    TEAM.draw(womens_singles).match('1.60').winner(women.Zheng).in_sets(
        3)  # (  Q) Tamara Zidansek  OR  ( 19) Qinwen Zheng
    TEAM.draw(womens_singles).match('1.61').winner(women.Zhang_Shuai).in_sets(
        3)  # ( 29) Shuai Zhang  OR  (   ) Magdalena Frech
    TEAM.draw(womens_singles).match('1.62').winner(women.Rakhimova).in_sets(
        3)  # (  Q) Sara Bejlek  OR  (   ) Kamilla Rakhimova

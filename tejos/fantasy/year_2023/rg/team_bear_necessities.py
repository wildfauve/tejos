...
def mens_singles_round_7(mens_singles):
    TEAM.draw(mens_singles).match('7.1').winner(men.Djokovic).in_sets(4)  # (  3) Djokovic  OR  (  4) Ruud
...
def mens_singles_round_6(mens_singles):
    ...
    TEAM.draw(mens_singles).match('6.2').winner(men.Ruud).in_sets(5)  # (  4) Ruud  OR  ( 22) Zverev
...
def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles).match('5.1').winner(men.Alcaraz).in_sets(3)  # (  1) Alcaraz  OR  (  5) Tsitsipas
...
def mens_singles_round_3(mens_singles):
    TEAM.draw(mens_singles).match('3.1').winner(men.Alcaraz).in_sets(3)  # (  1) Alcaraz  OR  ( 26) Shapovalov
    TEAM.draw(mens_singles).match('3.2').winner(men.Norrie).in_sets(4)  # ( 17) Musetti  OR  ( 14) Norrie
    TEAM.draw(mens_singles).match('3.3').winner(men.Fognini).in_sets(4)  # (   ) Fognini  OR  (  Q) Ofner
    TEAM.draw(mens_singles).match('3.4').winner(men.Tsitsipas).in_sets(4)  # (   ) Schwartzman  OR  (  5) Tsitsipas
    TEAM.draw(mens_singles).match('3.5').winner(men.Djokovic).in_sets(3)  # (  3) Djokovic  OR  ( 29) Davidovich_Fokina
    TEAM.draw(mens_singles).match('3.6').winner(men.Varillas).in_sets(4)  # (   ) Varillas  OR  ( 13) Hurkacz
    TEAM.draw(mens_singles).match('3.7').winner(men.Khachanov).in_sets(4)  # ( 11) Khachanov  OR  (  W) Kokkinakis
    TEAM.draw(mens_singles).match('3.8').winner(men.Rublev).in_sets(3)  # (   ) Sonego  OR  (  7) Rublev
    TEAM.draw(mens_singles).match('3.9').winner(men.Rune).in_sets(3)  # (  6) Rune  OR  (  Q) Olivieri
    TEAM.draw(mens_singles).match('3.10').winner(men.Fritz).in_sets(3)  # ( 23) Cerundolo_Francisco  OR  (  9) Fritz
    TEAM.draw(mens_singles).match('3.11').winner(men.Giron).in_sets(4)  # (   ) Jarry  OR  (   ) Giron
    TEAM.draw(mens_singles).match('3.12').winner(men.Ruud).in_sets(3)  # (   ) Zhang_Zhizhen  OR  (  4) Ruud
    TEAM.draw(mens_singles).match('3.13').winner(men.Dimitrov).in_sets(3)  # (   ) Altmaier  OR  ( 28) Dimitrov
    TEAM.draw(mens_singles).match('3.14').winner(men.Zverev).in_sets(3)  # ( 22) Zverev  OR  ( 12) Tiafoe
    TEAM.draw(mens_singles).match('3.15').winner(men.Coric).in_sets(4)  # ( 15) Coric  OR  (   ) Etcheverry
    TEAM.draw(mens_singles).match('3.16').winner(men.Nishioka).in_sets(5)  # ( 27) Nishioka  OR  (  Q) Seyboth_Wild
    return TEAM
...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles).match('3.3').winner(women.Day).in_sets(2)  # (   ) Schmiedlova  OR  (  Q) Day
    TEAM.draw(womens_singles).match('3.4').winner(women.Andreeva_Mirra).in_sets(
        3)  # (  Q) Andreeva_Mirra  OR  (  6) Gauff
    TEAM.draw(womens_singles).match('3.5').winner(women.Sorribes_Tormo).in_sets(
        3)  # (  4) Rybakina  OR  (   ) Sorribes_Tormo
    ...
    TEAM.draw(womens_singles).match('3.13').winner(women.Svitolina).in_sets(2)  # (   ) Blinkova  OR  (   ) Svitolina
    TEAM.draw(womens_singles).match('3.14').winner(women.Stearns).in_sets(3)  # (   ) Stearns  OR  (  9) Kasatkina
    TEAM.draw(womens_singles).match('3.15').winner(women.Putintseva).in_sets(2)  # (   ) Stephens  OR  (   ) Putintseva
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles).match('2.17').winner(men.Rune).in_sets(5)  # (  6) Rune  OR  (   ) Monfils
    TEAM.draw(mens_singles).match('2.18').winner(men.Olivieri).in_sets(4)  # (  Q) Olivieri  OR  (  Q) Vavassori
    TEAM.draw(mens_singles).match('2.19').winner(men.Hanfmann).in_sets(
        5)  # ( 23) Cerundolo_Francisco  OR  (  L) Hanfmann
    TEAM.draw(mens_singles).match('2.20').winner(men.Rinderknech).in_sets(5)  # (   ) Rinderknech  OR  (  9) Fritz
    TEAM.draw(mens_singles).match('2.21').winner(men.Paul).in_sets(4)  # ( 16) Paul  OR  (   ) Jarry
    TEAM.draw(mens_singles).match('2.22').winner(men.Giron).in_sets(5)  # (   ) Giron  OR  (   ) Lehecka
    TEAM.draw(mens_singles).match('2.23').winner(men.Tirante).in_sets(4)  # (  Q) Tirante  OR  (   ) Zhang_Zhizhen
    TEAM.draw(mens_singles).match('2.24').winner(men.Ruud).in_sets(5)  # (  Q) Zeppieri  OR  (  4) Ruud
    TEAM.draw(mens_singles).match('2.25').winner(men.Altmaier).in_sets(4)  # (  8) Sinner  OR  (   ) Altmaier
    TEAM.draw(mens_singles).match('2.26').winner(men.Ruusuvuori).in_sets(5)  # (   ) Ruusuvuori  OR  ( 28) Dimitrov
    ...
    TEAM.draw(mens_singles).match('2.30').winner(men.De_Minaur).in_sets(5)  # (   ) Etcheverry  OR  ( 18) De_Minaur
    TEAM.draw(mens_singles).match('2.31').winner(men.Nishioka).in_sets(5)  # ( 27) Nishioka  OR  (   ) Purcell
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles).match('2.3').winner(women.Navarro).in_sets(3)  # (   ) Andreescu  OR  (  W) Navarro
    TEAM.draw(womens_singles).match('2.4').winner(women.Davis).in_sets(3)  # (   ) Davis  OR  (   ) Tsurenko
    TEAM.draw(womens_singles).match('2.5').winner(women.Schmiedlova).in_sets(3)  # (   ) Schmiedlova  OR  (  L) Bolsova
    ...
    TEAM.draw(womens_singles).match('2.7').winner(women.Andreeva_Mirra).in_sets(
        3)  # (  W) Parry  OR  (  Q) Andreeva_Mirra
    TEAM.draw(womens_singles).match('2.8').winner(women.Gauff).in_sets(3)  # (   ) Grabher  OR  (  6) Gauff
    TEAM.draw(womens_singles).match('2.9').winner(women.Rybakina).in_sets(3)  # (  4) Rybakina  OR  (   ) Noskova
    TEAM.draw(womens_singles).match('2.10').winner(women.Martic).in_sets(2)  # (   ) Sorribes_Tormo  OR  (   ) Martic
    TEAM.draw(womens_singles).match('2.11').winner(women.Alexandrova).in_sets(
        2)  # ( 23) Alexandrova  OR  (   ) Friedsam
    TEAM.draw(womens_singles).match('2.12').winner(women.Shnaider).in_sets(3)  # (   ) Shnaider  OR  ( 14) Haddad_Maia
...
def mens_singles_round_1(mens_singles):
    ...
    TEAM.draw(mens_singles).match('1.10').winner(men.Diaz_Acosta).in_sets(
        5)  # (   ) Jason Kubler  OR  (  L) Diaz Acosta
    TEAM.draw(mens_singles).match('1.11').winner(men.Cressy).in_sets(
        5)  # (  Q) Sebastian Ofner  OR  (   ) Maxime Cressy
    ...
    TEAM.draw(mens_singles).match('1.18').winner(men.Grenier).in_sets(
    ...
    TEAM.draw(mens_singles).match('1.20').winner(men.Fils).in_sets(
        5)  # (  W) Arthur Fils  OR  ( 29) Alejandro Davidovich Fokina
    TEAM.draw(mens_singles).match('1.21').winner(men.Bautista_Agut).in_sets(
        4)  # ( 19) Roberto Bautista Agut  OR  (   ) Yibing Wu
    TEAM.draw(mens_singles).match('1.22').winner(men.Shang).in_sets(
        5)  # (  Q) Juncheng Shang  OR  (   ) Juan Pablo Varillas
    TEAM.draw(mens_singles).match('1.23').winner(men.Martinez).in_sets(
        5)  # (  Q) Pedro Martinez  OR  (   ) Tallon Griekspoor
    TEAM.draw(mens_singles).match('1.24').winner(men.Goffin).in_sets(4)  # (   ) David Goffin  OR  ( 13) Hubert Hurkacz
    TEAM.draw(mens_singles).match('1.25').winner(men.Lestienne).in_sets(
    ...
    TEAM.draw(mens_singles).match('1.31').winner(men.Cazaux).in_sets(
    ...
    TEAM.draw(mens_singles).match('1.38').winner(men.Monteiro).in_sets(
        5)  # (   ) Thiago Monteiro  OR  (   ) Benjamin Hanfmann
    ...
    TEAM.draw(mens_singles).match('1.43').winner(men.Medjedovic).in_sets(
        5)  # (  Q) H.Medjedovic  OR  (   ) Marcos Giron
    TEAM.draw(mens_singles).match('1.44').winner(men.Lehecka).in_sets(
        5)  # (   ) Jiri Lehecka  OR  ( 21) Jan-Lennard Struff
    ...
    TEAM.draw(mens_singles).match('1.53').winner(men.Zverev).in_sets(
        4)  # ( 22) Alexander Zverev  OR  (   ) Lloyd Harris
    ...
    TEAM.draw(mens_singles).match('1.55').winner(men.Karatsev).in_sets(
        5)  # (   ) Alexei Popyrin  OR  (  Q) Aslan Karatsev
    ...
    TEAM.draw(mens_singles).match('1.59').winner(men.Draper).in_sets(
        5)  # (   ) Jack Draper  OR  (   ) Tomas Martin Etcheverry
...
def womens_singles_round_1(womens_singles):
    ...
    TEAM.draw(womens_singles).match('1.6').winner(women.Navarro).in_sets(
    ...
    TEAM.draw(womens_singles).match('1.8').winner(women.Krejcikova).in_sets(
        3)  # (   ) Lesia Tsurenko  OR  ( 13) Barbora Krejcikova
    TEAM.draw(womens_singles).match(
        '1.9').winner(women.Kudermetova_Veronika).in_sets(
        3)  # ( 11) Veronika Kudermetova  OR  (   ) Anna Karolina Schmiedlova
    TEAM.draw(womens_singles).match('1.10').winner(women.Bolsova).in_sets(
    ...
    TEAM.draw(womens_singles).match('1.13').winner(women.Kalinina).in_sets(
        3)  # ( 25) Anhelina Kalinina  OR  (  W) Diane Parry
    TEAM.draw(womens_singles).match('1.14').winner(women.Andreeva_Mirra).in_sets(
    ...
    TEAM.draw(womens_singles).match('1.17').winner(women.Rybakina).in_sets(
        3)  # (  4) Elena Rybakina  OR  (  Q) Brenda Fruhvirtova
    ...
    TEAM.draw(womens_singles).match('1.20').winner(women.Martic).in_sets(
        3)  # (   ) Petra Martic  OR  ( 32) Shelby Rogers
    TEAM.draw(womens_singles).match(
        '1.21').winner(women.Alexandrova).in_sets(3)  # ( 23) Ekaterina Alexandrova  OR  (   ) Viktoriya Tomova
    TEAM.draw(womens_singles).match('1.22').winner(women.Hibino).in_sets(
    ...
    TEAM.draw(womens_singles).match('1.24').winner(women.Haddad_Maia).in_sets(
        2)  # (   ) Tatjana Maria  OR  ( 14) Beatriz Haddad Maia
    TEAM.draw(womens_singles).match('1.25').winner(women.Kvitova).in_sets(
        2)  # ( 10) Petra Kvitova  OR  (   ) Elisabetta Cocciaretto
    TEAM.draw(womens_singles).match('1.26').winner(women.Mandlik).in_sets(
        2)  # (  Q) Simona Waltert  OR  (  Q) Elizabeth Mandlik
    ...
    TEAM.draw(womens_singles).match('1.30').winner(women.Danilovic).in_sets(
        2)  # (  Q) Olga Danilovic  OR  (   ) Kateryna Baindl
    TEAM.draw(womens_singles).match('1.31').winner(women.Janicijevic).in_sets(
        3)  # (  W) Selena Janicijevic  OR  (   ) Dodin
    ...
    TEAM.draw(womens_singles).match('1.38').winner(women.Tauson).in_sets(
        3)  # (  Q) C.Tauson  OR  (   ) Aliaksandra Sasnovich
    TEAM.draw(womens_singles).match('1.39').winner(women.Birrell).in_sets(
        2)  # (  W) Leolia Jeanjean  OR  (  W) Kimberly Birrell
    ...
    TEAM.draw(womens_singles).match('1.43').winner(women.Brengle).in_sets(
    ...
    TEAM.draw(womens_singles).match('1.47').winner(women.Cornet).in_sets(
        2)  # (   ) Alize Cornet  OR  (   ) Camila Giorgi
    ...
    TEAM.draw(womens_singles).match('1.50').winner(women.Blinkova).in_sets(
        2)  # (   ) Anna Blinkova  OR  (   ) Ysaline Bonaventure
    TEAM.draw(womens_singles).match('1.51').winner(women.Hunter).in_sets(
    ...
    TEAM.draw(womens_singles).match('1.54').winner(women.Stearns).in_sets(
    ...
    TEAM.draw(womens_singles).match('1.62').winner(women.Bejlek).in_sets(

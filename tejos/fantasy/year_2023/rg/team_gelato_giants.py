...
def womens_singles_round_6(womens_singles):
    ...
    TEAM.draw(womens_singles).match('6.2').winner(women.Sabalenka).in_sets(3)  # (   ) Muchova  OR  (  2) Sabalenka
...
def mens_singles_round_3(mens_singles):
    ...
    TEAM.draw(mens_singles).match('3.2').winner(men.Musetti).in_sets(4)  # ( 17) Musetti  OR  ( 14) Norrie
    ...
    TEAM.draw(mens_singles).match('3.14').winner(men.Tiafoe).in_sets(3)  # ( 22) Zverev  OR  ( 12) Tiafoe
    TEAM.draw(mens_singles).match('3.15').winner(men.Etcheverry).in_sets(4)  # ( 15) Coric  OR  (   ) Etcheverry
...
def womens_singles_round_3(womens_singles):
    ...
    TEAM.draw(womens_singles).match('3.15').winner(women.Stephens).in_sets(2)  # (   ) Stephens  OR  (   ) Putintseva
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles).match('2.24').winner(men.Zeppieri).in_sets(5)  # (  Q) Zeppieri  OR  (  4) Ruud
    ...
    TEAM.draw(mens_singles).match('2.27').winner(men.Molcan).in_sets(4)  # ( 22) Zverev  OR  (   ) Molcan
    TEAM.draw(mens_singles).match('2.28').winner(men.Tiafoe).in_sets(3)  # (  Q) Karatsev  OR  ( 12) Tiafoe
    TEAM.draw(mens_singles).match('2.29').winner(men.Cachin).in_sets(4)  # ( 15) Coric  OR  (   ) Cachin
    TEAM.draw(mens_singles).match('2.30').winner(men.Etcheverry).in_sets(4)  # (   ) Etcheverry  OR  ( 18) De_Minaur
    TEAM.draw(mens_singles).match('2.31').winner(men.Purcell).in_sets(4)  # ( 27) Nishioka  OR  (   ) Purcell
    TEAM.draw(mens_singles).match('2.32').winner(men.Seyboth_Wild).in_sets(4)  # (   ) Pella  OR  (  Q) Seyboth_Wild
    return TEAM


def womens_singles_round_2(womens_singles):
    TEAM.draw(womens_singles).match('2.1').winner(women.Liu).in_sets(3)  # (  1) Swiatek  OR  (   ) Liu
    TEAM.draw(womens_singles).match('2.2').winner(women.Peterson).in_sets(2)  # (   ) Peterson  OR  (   ) Wang_Xinyu
    TEAM.draw(womens_singles).match('2.3').winner(women.Andreescu).in_sets(2)  # (   ) Andreescu  OR  (  W) Navarro
    TEAM.draw(womens_singles).match('2.4').winner(women.Tsurenko).in_sets(2)  # (   ) Davis  OR  (   ) Tsurenko
    TEAM.draw(womens_singles).match('2.5').winner(women.Bolsova).in_sets(2)  # (   ) Schmiedlova  OR  (  L) Bolsova
    ...
    TEAM.draw(womens_singles).match('2.8').winner(women.Hruncakova).in_sets(2)  # (   ) Grabher  OR  (  6) Gauff
...
def mens_singles_round_1(mens_singles):
    ...
    TEAM.draw(mens_singles).match('1.6').winner(men.Otte).in_sets(4)  # (   ) Alexander Shevchenko  OR  (   ) Oscar Otte
    ...
    TEAM.draw(mens_singles).match('1.26').winner(men.Kypson).in_sets(5)  # (  W) Patrick Kypson  OR  (  Q) Radu Albot
    ...
    TEAM.draw(mens_singles).match('1.46').winner(men.Lajovic).in_sets(5)  # (   ) Zhizhen Zhang  OR  (   ) Dusan Lajovic
...
def womens_singles_round_1(womens_singles):
    ...
    TEAM.draw(womens_singles).match('1.11').winner(women.Mladenovic).in_sets(
        2)  # (  Q) K.Day  OR  (  W) Kristina Mladenovic
    ...
    TEAM.draw(womens_singles).match('1.46').winner(women.Bogdan).in_sets(

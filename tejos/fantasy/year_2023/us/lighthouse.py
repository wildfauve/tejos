...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles, '4.5').matchup(1, women.Stearns, 2, women.Vondrousova).select(2, 3)  # (   ) Peyton Stearns  OR  (  9) Marketa Vondrousova
    TEAM.draw(womens_singles).match('4.6').winner(women.Keys).in_sets(3)  # ( 17) Madison Keys  OR  (  3) Jessica Pegula
    TEAM.draw(womens_singles, '4.7').matchup(1, women.Zheng, 2, women.Jabeur).select(1, 3)  # ( 23) Qinwen Zheng  OR  (  5) Ons Jabeur
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles, '4.2').matchup(1, men.Sinner, 2, men.Zverev).select(1, 5)  # (  6) Jannik Sinner  OR  ( 12) Alexander Zverev
    TEAM.draw(mens_singles, '4.3').matchup(1, men.Medvedev, 2, men.Alex_de_Minaur).select(1, 5)  # (  3) Daniil Medvedev  OR  ( 13) Alex de Minaur

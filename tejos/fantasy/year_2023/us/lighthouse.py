...
def mens_singles_round_6(mens_singles):
    TEAM.draw(mens_singles).match('6.1').winner(men.Alcaraz).in_sets(3)  # (  3) Daniil Medvedev  OR  (  1) Carlos Alcaraz
    TEAM.draw(mens_singles).match('6.2').winner(men.Djokovic).in_sets(5)  # (  2) Novak Djokovic  OR  (   ) Ben Shelton
# mens_singles_round_6:END


# womens_singles_round_5:START
def womens_singles_round_5(womens_singles):
    TEAM.draw(womens_singles).match('5.1').winner(women.Ostapenko).in_sets(3)  # ( 20) Jelena Ostapenko  OR  (  6) Coco Gauff
    TEAM.draw(womens_singles).match('5.2').winner(women.Cirstea).in_sets(3)  # ( 30) Sorana Cirstea  OR  ( 10) Karolina Muchova
    TEAM.draw(womens_singles).match('5.3').winner(women.Keys).in_sets(3)  # (  9) Marketa Vondrousova  OR  ( 17) Madison Keys
    TEAM.draw(womens_singles, '5.4').matchup(1, women.Zheng, 2, women.Sabalenka).select(2, 3)  # ( 23) Qinwen Zheng  OR  (  2) Aryna Sabalenka
# womens_singles_round_5:END


# mens_singles_round_5:START
def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles, '5.1').matchup(1, men.Alcaraz, 2, men.Zverev).select(2, 5)  # (  1) Carlos Alcaraz  OR  ( 12) Alexander Zverev
    TEAM.draw(mens_singles, '5.2').matchup(1, men.Rublev, 2, men.Medvedev).select(2, 4)  # (  8) Andrey Rublev  OR  (  3) Daniil Medvedev
    TEAM.draw(mens_singles).match('5.3').winner(men.Shelton).in_sets(5)  # (   ) Ben Shelton  OR  ( 10) Frances Tiafoe
    TEAM.draw(mens_singles).match('5.4').winner(men.Djokovic).in_sets(4)  # (  9) Taylor Fritz  OR  (  2) Novak Djokovic
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles).match('4.5').winner(women.Vondrousova).in_sets(3)  # (   ) Peyton Stearns  OR  (  9) Marketa Vondrousova
    TEAM.draw(womens_singles).match('4.6').winner(women.Keys).in_sets(3)  # ( 17) Madison Keys  OR  (  3) Jessica Pegula
    TEAM.draw(womens_singles).match('4.7').winner(women.Zheng).in_sets(3)  # ( 23) Qinwen Zheng  OR  (  5) Ons Jabeur
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles).match('4.2').winner(men.Sinner).in_sets(5)  # (  6) Jannik Sinner  OR  ( 12) Alexander Zverev
    TEAM.draw(mens_singles).match('4.3').winner(men.Medvedev).in_sets(5)  # (  3) Daniil Medvedev  OR  ( 13) Alex de Minaur
    ...
    TEAM.draw(mens_singles).match('4.6').winner(men.Paul).in_sets(4)  # ( 14) Tommy Paul  OR  (   ) Ben Shelton
    TEAM.draw(mens_singles).match('4.7').winner(men.Fritz).in_sets(4)  # (  Q) D.Stricker  OR  (  9) Taylor Fritz
    TEAM.draw(mens_singles).match('4.8').winner(men.Djokovic).in_sets(4)  # (  Q) Borna Gojo  OR  (  2) Novak Djokovic
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles, '2.2').matchup(1, men.Evans, 2, men.Botic_van_De_Zandschulp).select(2, 4)  # ( 26) Daniel Evans  OR  (   ) Botic van De Zandschulp

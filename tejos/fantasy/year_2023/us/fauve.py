...
def womens_singles_round_6(womens_singles):
    TEAM.draw(womens_singles, '6.1').matchup(1, women.Gauff, 2, women.Muchova).select(1, 2)  # (  6) Coco Gauff  OR  ( 10) Karolina Muchova
...
def mens_singles_round_6(mens_singles):
    ...
    TEAM.draw(mens_singles, '6.2').matchup(1, men.Djokovic, 2, men.Shelton).select(2, 3)  # (  2) Novak Djokovic  OR  (   ) Ben Shelton

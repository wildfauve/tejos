...
def mens_singles_round_1(mens_singles):
    ...
    TEAM.draw(mens_singles, '1.19').matchup(1, men.Kei_Nishikori, 2, men.Felipe_Meligeni_Alves).select(1, 3)  # (   ) Kei Nishikori  OR  (  Q) Felipe Meligeni Alves
    ...
    TEAM.draw(mens_singles, '1.32').matchup(1, men.Ruusuvuori, 2, men.Rublev).select(2, 4)  # (   ) Emil Ruusuvuori  OR  (  8) Andrey Rublev

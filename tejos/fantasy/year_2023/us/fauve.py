...
def womens_singles_round_7(womens_singles):
    TEAM.draw(womens_singles).match('7.1').winner(women.Sabalenka).in_sets(3)  # (  6) Coco Gauff  OR  (  2) Aryna Sabalenka
# womens_singles_round_7:END


# mens_singles_round_7:START
def mens_singles_round_7(mens_singles):
    TEAM.draw(mens_singles, '7.1').matchup(1, men.Djokovic, 2, men.Medvedev).select(1, 4)  # (  2) Novak Djokovic  OR  (  3) Daniil Medvedev
# mens_singles_round_7:END


# womens_singles_round_6:START
def womens_singles_round_6(womens_singles):
    TEAM.draw(womens_singles).match('6.1').winner(women.Gauff).in_sets(2)  # (  6) Coco Gauff  OR  ( 10) Karolina Muchova
    TEAM.draw(womens_singles, '6.2').matchup(1, women.Keys, 2, women.Sabalenka).select()  # ( 17) Madison Keys  OR  (  2) Aryna Sabalenka
...
def mens_singles_round_6(mens_singles):
    ...
    TEAM.draw(mens_singles).match('6.2').winner(men.Shelton).in_sets(3)  # (  2) Novak Djokovic  OR  (   ) Ben Shelton
...
def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles, '5.1').matchup(1, men.Alcaraz, 2, men.Zverev).select(1, 5)  # (  1) Carlos Alcaraz  OR  ( 12) Alexander Zverev
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles).match('4.2').winner(men.Sinner).in_sets(3)  # (  6) Jannik Sinner  OR  ( 12) Alexander Zverev

...
def womens_singles_round_6(womens_singles):
    TEAM.draw(womens_singles, '6.1').matchup(1, women.Gauff, 2, women.Muchova).select(1, 3)  # (  6) Coco Gauff  OR  ( 10) Karolina Muchova
    TEAM.draw(womens_singles, '6.2').matchup(1, women.Keys, 2, women.Sabalenka).select(2, 3)  # ( 17) Madison Keys  OR  (  2) Aryna Sabalenka

...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles, '4.3').matchup(1, women.Cirstea, 2, women.Bencic).select(2, 2)  # ( 30) Sorana Cirstea  OR  ( 15) Belinda Bencic
    TEAM.draw(womens_singles, '4.4').matchup(1, women.Muchova, 2, women.Wang_Xinyu).select(1, 2)  # ( 10) Karolina Muchova  OR  (   ) Xinyu Wang
...
def mens_singles_round_4(mens_singles):
    TEAM.draw(mens_singles, '4.1').matchup(1, men.Alcaraz, 2, men.Arnaldi).select(2, 4)  # (  1) Carlos Alcaraz  OR  (   ) Matteo Arnaldi

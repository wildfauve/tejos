...
def womens_singles_round_5(womens_singles):
    TEAM.draw(womens_singles).match('5.1').winner(women.Gauff).in_sets(2)  # ( 20) Jelena Ostapenko  OR  (  6) Coco Gauff
    TEAM.draw(womens_singles).match('5.2').winner(women.Muchova).in_sets(2)  # ( 30) Sorana Cirstea  OR  ( 10) Karolina Muchova
    TEAM.draw(womens_singles).match('5.3').winner(women.Vondrousova).in_sets(2)  # (  9) Marketa Vondrousova  OR  ( 17) Madison Keys
...
def mens_singles_round_5(mens_singles):
    TEAM.draw(mens_singles, '5.1').matchup(1, men.Alcaraz, 2, men.Zverev).select(1, 3)  # (  1) Carlos Alcaraz  OR  ( 12) Alexander Zverev
    TEAM.draw(mens_singles, '5.2').matchup(1, men.Rublev, 2, men.Medvedev).select(2, 4)  # (  8) Andrey Rublev  OR  (  3) Daniil Medvedev
    TEAM.draw(mens_singles).match('5.3').winner(men.Shelton).in_sets(4)  # (   ) Ben Shelton  OR  ( 10) Frances Tiafoe
...
def womens_singles_round_4(womens_singles):
    ...
    TEAM.draw(womens_singles).match('4.7').winner(women.Zheng).in_sets(2)  # ( 23) Qinwen Zheng  OR  (  5) Ons Jabeur
...
def mens_singles_round_4(mens_singles):
    ...
    TEAM.draw(mens_singles).match('4.3').winner(men.Alex_de_Minaur).in_sets(4)  # (  3) Daniil Medvedev  OR  ( 13) Alex de Minaur
...
def womens_singles_round_2(womens_singles):
    ...
    TEAM.draw(womens_singles, '2.29').matchup(1, women.Kasatkina, 2, women.Kenin).select(2, 2)  # ( 13) Daria Kasatkina  OR  (   ) Sofia Kenin
...
def mens_singles_round_2(mens_singles):
    ...
    TEAM.draw(mens_singles, '2.2').matchup(1, men.Evans, 2, men.Botic_van_De_Zandschulp).select(1, 3)  # ( 26) Daniel Evans  OR  (   ) Botic van De Zandschulp

...
def womens_singles_round_7(womens_singles):
    TEAM.draw(womens_singles).match('7.1').winner(women.Sabalenka).in_sets(2)  # (  6) Coco Gauff  OR  (  2) Aryna Sabalenka
# womens_singles_round_7:END


# mens_singles_round_7:START
def mens_singles_round_7(mens_singles):
    TEAM.draw(mens_singles, '7.1').matchup(1, men.Djokovic, 2, men.Medvedev).select(1, 5)  # (  2) Novak Djokovic  OR  (  3) Daniil Medvedev

...
class PlayerRepo(graphrepo.GraphRepo):
    ...
    def creator(self, player, g, sub):
        ...
        g.add((sub, rdf.hasTourDesignation, Literal(player.tour_symbol)))
    ...
    def _name_sparql(self, name=None, klass_name=None, alt_name=None):
        ...
        ?sub a clo-te:Player ;
             foaf:name ?name ;
             clo-te-plr:hasTourDesignation ?tour_symbol ;
             clo-te-plr:hasKlassName ?klass_name .
             
        OPTIONAL {{ ?sub clo-te-plr:hasAltName ?alt_names .}} 
